        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='journal_id.default_account_id', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                            ...
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        ...
                                                        args=[Constant(value="You can't validate a bank statement that is used in an opened Session of a Point of Sale.", kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        For(
                            target=Name(id='bs', ctx=Store()),
                            iter=Name(id='self', ctx=Load()),
                            body=[
                                If(
                                    test=Attribute(
                                        value=Name(id='bs', ctx=Load()),
                                        attr='pos_session_id',
                                        ctx=Load(),
                                    ),
                                    body=[
                                        Raise(
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        func=Name(id='_', ctx=Load()),
                                                        args=[Constant(value='You cannot delete a bank statement linked to Point of Sale session.', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
