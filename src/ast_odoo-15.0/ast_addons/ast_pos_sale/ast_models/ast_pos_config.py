    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value="This Point of sale's sales will be related to this Sales Team.", kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='down_payment_product_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='This product will be used as down payment on a sale order.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='default_sale_team', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                        ...
                        If(
                            test=BoolOp(
                                op=And(),
                                values=[
                                    Name(id='default_sale_team', ctx=Load()),
                                    BoolOp(
                                        op=Or(),
                                        values=[
                                            UnaryOp(
                                                op=Not(),
                                                operand=Attribute(
                                                    value=Name(id='default_sale_team', ctx=Load()),
                                                    attr='company_id',
                                                    ctx=Load(),
                                                ),
                                            ),
