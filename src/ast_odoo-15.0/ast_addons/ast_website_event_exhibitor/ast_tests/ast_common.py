                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestEventExhibitorCommon', ctx=Load()),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='GigaTop', kind=None),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='EventSponsor', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Attribute(
                                            ...
                                            Constant(value='event.sponsor@example.com', kind=None),
                                            Constant(value='04856112233', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
