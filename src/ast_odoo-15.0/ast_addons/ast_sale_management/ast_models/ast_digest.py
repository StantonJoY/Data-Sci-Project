    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='kpi_all_sale_total', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='All Sales', kind=None)],
                        keywords=[],
                    ),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='kpi_all_sale_total_value', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Monetary',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_kpi_sale_total_value', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                    ...
                    body=[
                        ...
                        For(
                            ...
                            body=[
                                ...
                                Assign(
                                    targets=[Name(id='all_channels_sales', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                                        ...
                                        args=[
                                            ...
                                            List(
                                                elts=[Constant(value='price_total', kind=None)],
                                                ctx=Load(),
                                            ),
                                            List(
                                                elts=[Constant(value='price_total', kind=None)],
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            ListComp(
                                                elt=Subscript(
                                                    value=Name(id='channel_sale', ctx=Load()),
                                                    slice=Constant(value='price_total', kind=None),
                                                    ctx=Load(),
                                                ),
                                                generators=[
                                                    comprehension(
                                                        target=Name(id='channel_sale', ctx=Store()),
                                                        iter=Name(id='all_channels_sales', ctx=Load()),
                                                        ifs=[],
                                                        is_async=0,
                                                    ),
                                                ],
                        ...
                        Assign(
                            targets=[
                                Subscript(
                                    ...
                                    slice=Constant(value='kpi_all_sale_total', kind=None),
                                    ctx=Store(),
                                ),
                            ],
                            value=BinOp(
                                left=Constant(value='sale.report_all_channels_sales_action&menu_id=%s', kind=None),
                                op=Mod(),
                                right=Attribute(
                                    value=Call(
                                        func=Attribute(
                                        ...
                                        args=[Constant(value='sale.sale_menu_root', kind=None)],
                                        keywords=[],
                                    ),
                                    attr='id',
                                    ctx=Load(),
