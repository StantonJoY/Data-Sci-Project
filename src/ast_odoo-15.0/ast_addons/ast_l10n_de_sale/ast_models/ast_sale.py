                                                            ...
                                                            Tuple(
                                                                elts=[
                                                                    Call(
                                                                        ...
                                                                        args=[Constant(value='Quotation No.', kind=None)],
                                                                        keywords=[],
                                                                    ),
                                                                    Attribute(
                                                                        value=Name(id='record', ctx=Load()),
                                                        ...
                                                        args=[
                                                            Tuple(
                                                                elts=[
                                                                    Call(
                                                                        func=Name(id='_', ctx=Load()),
                                                                        args=[Constant(value='Quotation Date', kind=None)],
                                                                        keywords=[],
                                                                    ),
                                                                    Call(
                                                        ...
                                                        args=[
                                                            Tuple(
                                                                elts=[
                                                                    Call(
                                                                        func=Name(id='_', ctx=Load()),
                                                                        args=[Constant(value='Expiration', kind=None)],
                                                                        keywords=[],
                                                                    ),
                                                                    Call(
                                                                        func=Name(id='format_date', ctx=Load()),
                                                        ...
                                                        args=[
                                                            Tuple(
                                                                elts=[
                                                                    Call(
                                                                        func=Name(id='_', ctx=Load()),
                                                                        args=[Constant(value='Order No.', kind=None)],
                                                                        keywords=[],
                                                                    ),
                                                                    Attribute(
                                                                        value=Name(id='record', ctx=Load()),
                                                ...
                                                args=[
                                                    Tuple(
                                                        elts=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[Constant(value='Customer Reference', kind=None)],
                                                                keywords=[],
                                                            ),
                                                            Attribute(
                                                                value=Name(id='record', ctx=Load()),
                                                ...
                                                args=[
                                                    Tuple(
                                                        elts=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[Constant(value='Salesperson', kind=None)],
                                                                keywords=[],
                                                            ),
                                                            Attribute(
                                                                value=Attribute(
                                                ...
                                                args=[
                                                    Tuple(
                                                        elts=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[Constant(value='Invoicing and Shipping Address:', kind=None)],
                                                                keywords=[],
                                                            ),
                                                            Attribute(
                                                                value=Name(id='record', ctx=Load()),
                                                ...
                                                args=[
                                                    Tuple(
                                                        elts=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[Constant(value='Invoicing Address:', kind=None)],
                                                                keywords=[],
                                                            ),
                                                            Attribute(
                                                                value=Name(id='record', ctx=Load()),
