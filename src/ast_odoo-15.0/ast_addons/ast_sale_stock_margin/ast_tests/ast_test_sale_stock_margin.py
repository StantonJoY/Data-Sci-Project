            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestSaleStockMargin', ctx=Load()),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[Constant(value='Simple Pricelist', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='order_line_1', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='_create_sale_order_line',
                        ...
                        Assign(
                            targets=[Name(id='order_line_2', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='_create_sale_order_line',
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='order_line_1', ctx=Load()),
                                        attr='purchase_price',
                                        ctx=Load(),
                                    ),
                                    Constant(value=35, kind=None),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='order_line_2', ctx=Load()),
                                        attr='purchase_price',
                                        ctx=Load(),
                                    ),
                                    Constant(value=17, kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=IfExp(
                                test=Compare(
                                    left=Name(id='company_currency', ctx=Load()),
                                    ops=[Eq()],
                                    comparators=[
                                        Call(
                                            func=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='other_currency_rate', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='ResCurrencyRate', ctx=Load()),
                                    attr='search',
                        ...
                        If(
                            test=Name(id='other_currency_rate', ctx=Load()),
                            body=[
                                Assign(
                                    targets=[
                                        Attribute(
                                            value=Name(id='other_currency_rate', ctx=Load()),
                                            attr='rate',
                                            ctx=Store(),
                                        ),
                                    ],
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='main_company_currency', ctx=Store())],
                            value=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='new_company_currency', ctx=Store())],
                            value=IfExp(
                                test=Compare(
                                    left=Name(id='main_company_currency', ctx=Load()),
                                    ops=[Eq()],
                                    comparators=[
                                        Call(
                                            func=Attribute(
                                    ...
                                    List(
                                        elts=[
                                            Dict(
                                                ...
                                                values=[
                                                    Attribute(
                                                        value=Name(id='main_company_currency', ctx=Load()),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ),
                                                    Constant(value=1, kind=None),
                                            ...
                                            Dict(
                                                ...
                                                values=[
                                                    Attribute(
                                                        value=Name(id='new_company_currency', ctx=Load()),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Super Company', kind=None),
                                            Attribute(
                                                value=Name(id='new_company_currency', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                        ...
                        Assign(
                            targets=[Name(id='incoming_picking_type', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Attribute(
                                                value=Name(id='incoming_picking_type', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                            Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Incoming Product', kind=None),
                                            Attribute(
                                                value=Name(id='product', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='Super Partner', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
