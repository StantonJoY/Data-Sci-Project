                    ...
                    body=[
                        ...
                        If(
                            ...
                            test=Call(
                                ...
                                args=[Constant(lineno=12, col_offset=35, end_lineno=12, end_col_offset=77, value='hr_timesheet.group_hr_timesheet_approver', kind=None)],
                                keywords=[],
                            ),
                            body=[
                                Expr(
                                        ...
                                        args=[
                                            Attribute(
                                                ...
                                                value=Call(
                                                    ...
                                                    args=[Constant(lineno=13, col_offset=36, end_lineno=13, end_col_offset=79, value='hr_timesheet.timesheet_menu_activity_user', kind=None)],
                                                    keywords=[],
                                                ),
                                                attr='id',
                                                ctx=Load(),
