                ...
                FunctionDef(
                    ...
                    body=[
                                            ...
                                            Dict(
                                                ...
                                                values=[
                                                    Call(
                                                        ...
                                                        args=[Constant(value='Oops', kind=None)],
                                                        keywords=[],
                                                    ),
                                                    Call(
                                                        func=Name(id='_', ctx=Load()),
                                                        args=[Constant(value="The requested page is invalid, or doesn't exist anymore.", kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                            ),
                        ...
                        Assign(
                            ...
                            value=Dict(
                                keys=[
                                    Constant(value='use_invoice_terms', kind=None),
                        ...
                        Return(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='account.account_terms_conditions_page', kind=None),
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/terms', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
