        ...
        ClassDef(
            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Test cancel purchase order with group user.', kind=None),
                        ),
                        Assign(
                        ...
                        Assign(
                            targets=[Name(id='po_edit_with_user', ctx=Store())],
                            value=Call(
                                func=Attribute(
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='po_edit_with_user', ctx=Load()),
                                    attr='button_confirm',
                                    ctx=Load(),
                                ),
                                args=[],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Purchase: PO state should be "Cancel', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Create a PO with lines using packaging, check the packaging propagate\n        to its move.\n        ', kind=None),
                        ),
                        Assign(
