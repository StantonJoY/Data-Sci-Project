Module(
    body=[
        ...
        ClassDef(
            ...
            body=[
                Expr(
                    value=Constant(value=' Category of the product such as pizza, sandwich, pasta, chinese, burger... ', kind=None),
                ),
                Assign(
                    ...
                    body=[
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Constant(value='lunch', kind=None),
                                    Constant(value='static/img', kind=None),
                                    Constant(value='lunch.png', kind=None),
                                ],
                                keywords=[],
                            ),
                            type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='The number of products related to this category', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='all_products', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='Product', ctx=Load()),
                                    attr='search',
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='all_products', ctx=Load()),
