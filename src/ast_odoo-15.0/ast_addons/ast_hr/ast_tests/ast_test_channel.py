            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='emp0', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Test Department', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                    ...
                    body=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='subscription_department_ids', kind=None)],
                                        values=[
                                            List(
                                                elts=[
                                                    Tuple(
                            ...
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Call(
                                        ...
                                        args=[Constant(value='member_ids.user_id.partner_id', kind=None)],
                                        keywords=[],
                                    ),
                                ],
                                keywords=[],
