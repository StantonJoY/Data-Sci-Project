            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='crm_lead', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='crm_lead', ctx=Load()),
                                    attr='message_post',
                                    ctx=Load(),
                                ),
                                args=[],
                    ...
                    decorator_list=[
                        Call(
                            ...
                            keywords=[
                                keyword(
                                    arg='route',
                                    value=Constant(value='/mail_client_extension/log_single_mail_content', kind=None),
                                ),
                                keyword(
                                    arg='type',
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='partner_instance', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Return(
                            value=Dict(
                                keys=[Constant(value='leads', kind=None)],
                                values=[
                                    Call(
                                        func=Attribute(
                                        ...
                                        args=[
                                            Name(id='partner_instance', ctx=Load()),
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/mail_client_extension/lead/get_by_partner_id', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
                                    value=Constant(value='json', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='crm_mail_plugin.lead_creation_prefilled_action', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                        Return(
                            value=Call(
                                ...
                                args=[
                                    BinOp(
                                        left=Constant(value='/web#action=%s&model=crm.lead&partner_id=%s', kind=None),
                                        op=Mod(),
                                        right=Tuple(
                                            elts=[
                                                Attribute(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/mail_client_extension/lead/create_from_partner', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
                ...
                FunctionDef(
                    ...
                    body=[
                                    ...
                                    Dict(
                                        ...
                                        values=[
                                            Call(
                                                ...
                                                args=[Name(id='email_subject', ctx=Load())],
                                                keywords=[],
                                            ),
                        ...
                        Return(
                            value=Dict(
                                keys=[Constant(value='lead_id', kind=None)],
                                values=[
                                    Attribute(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/mail_plugin/lead/create', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
                                    value=Constant(value='json', kind=None),
                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        args=[
                            arg(arg='self', annotation=None, type_comment=None),
                            arg(arg='lead_id', annotation=None, type_comment=None),
                        ],
                        vararg=None,
                        kwonlyargs=[],
                        kw_defaults=[],
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='crm.crm_lead_view_form', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                        Assign(
                            ...
                            value=BinOp(
                                left=Constant(value='/web#id=%s&action=%s&model=crm.lead&edit=1&model=crm.lead', kind=None),
                                op=Mod(),
                                right=Tuple(
                                    elts=[
                                        Name(id='lead_id', ctx=Load()),
                                        Attribute(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/mail_client_extension/lead/open', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
                                    value=Constant(value='http', kind=None),
