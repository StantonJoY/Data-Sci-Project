            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestMrpSubcontractingCommon', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='main_partner', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Attribute(
                                                value=Name(id='main_partner', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                            Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='component for Component2', kind=None),
                                            Constant(value='product', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
