        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='microsoft.calendar.account.reset', kind=None),
                    type_comment=None,
                ),
                Assign(
                        ...
                        args=[
                            List(
                                elts=[
                                    ...
                                    Tuple(
                                        elts=[
                                            Constant(value='delete_microsoft', kind=None),
                                            Constant(value='Delete from the current Microsoft Calendar account', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                    ...
                    body=[
                                        ...
                                        For(
                                            ...
                                            body=[
                                                Expr(
                                                    value=Call(
                                                        func=Attribute(
                                                            value=Name(id='microsoft', ctx=Load()),
                                                            attr='delete',
                                                            ctx=Load(),
                                                        ),
                                                        args=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='microsoft_calendar_sync_token', kind=None)],
