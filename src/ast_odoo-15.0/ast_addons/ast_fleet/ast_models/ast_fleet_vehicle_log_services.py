        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='fleet.vehicle.log.services', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Constant(value='service_type_id', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Services for vehicles', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    targets=[Name(id='odometer_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                        ...
                        args=[
                            Constant(value='fleet.vehicle.odometer', kind=None),
                            Constant(value='Odometer', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='help',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='string',
                                value=Constant(value='Odometer Value', kind=None),
                            ),
                            keyword(
                                arg='help',
                                value=Constant(value='Odometer measure of the vehicle at the moment of this log', kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_purchaser_id', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                ...
                Assign(
                    targets=[Name(id='inv_ref', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Char',
                ...
                Assign(
                    targets=[Name(id='service_type_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                        ...
                        args=[
                            ...
                            Constant(value='Service Type', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='required',
                            ...
                            keyword(
                                ...
                                value=Lambda(
                                    ...
                                    body=Call(
                                        ...
                                        args=[Constant(value='fleet.type_service_service_8', kind=None)],
                                        keywords=[
                                            keyword(
                                            ...
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        ...
                                                        args=[Constant(value='Emptying the odometer value of a vehicle is not allowed.', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
                            ...
                            body=[
                                If(
                                    test=BoolOp(
                                        ...
                                        values=[
                                            Compare(
                                                left=Constant(value='odometer', kind=None),
                                                ops=[In()],
                                            ...
                                            UnaryOp(
                                                ...
                                                operand=Subscript(
                                                    ...
                                                    slice=Constant(value='odometer', kind=None),
                                                    ctx=Load(),
                                                ),
                                            ),
                                        ],
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='FleetVehicleLogServices', ctx=Load()),
                ...
                FunctionDef(
                    ...
                    body=[
                        For(
                            target=Name(id='service', ctx=Store()),
                            iter=Name(id='self', ctx=Load()),
                            body=[
                                Assign(
                                    targets=[
