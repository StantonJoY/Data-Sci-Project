        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='crm.lead.pls.update', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Update the probabilities', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='pls_start_date_config', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                        ...
                        Return(
                            value=Call(
                                ...
                                args=[Name(id='pls_start_date_config', ctx=Load())],
                                keywords=[],
                            ),
                        ),
                    ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='pls_fields_config', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                        ...
                        If(
                            test=Name(id='pls_fields_config', ctx=Load()),
                            body=[
                                Assign(
                                    targets=[Name(id='names', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='pls_fields_config', ctx=Load()),
                                            attr='split',
                                            ctx=Load(),
                                        ),
                ...
                Assign(
                    targets=[Name(id='pls_start_date', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Date',
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='default',
                                value=Name(id='_get_default_pls_start_date', ctx=Load()),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='pls_fields', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2many',
                        ...
                        keywords=[
                            keyword(
                                arg='default',
                                value=Name(id='_get_default_pls_fields', ctx=Load()),
                            ),
                        ],
                    ),
                    type_comment=None,
