    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                            ...
                            keyword(
                                ...
                                value=List(
                                    elts=[
                                        Tuple(
                                            elts=[
                                                Constant(value='purchase_liquidation', kind=None),
                                                Constant(value='Purchase Liquidation', kind=None),
                                            ],
                                            ctx=Load(),
                                        ),
                                    ],
                ...
                Assign(
                    targets=[Name(id='l10n_ec_check_format', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Check Number Format EC', kind=None),
                            ),
                            keyword(
                                arg='default',
                                ...
                                values=[
                                    UnaryOp(
                                        ...
                                        operand=Call(
                                            ...
                                            args=[
                                                Constant(value='\\d{3}-\\d{3}-\\d{9}$', kind=None),
                                    ...
                                    UnaryOp(
                                        ...
                                        operand=Call(
                                            ...
                                            args=[
                                                Constant(value='l10n_ec_foreign', kind=None),
                                        ...
                                        args=[
                                            BinOp(
                                                left=Call(
                                                    ...
                                                    args=[Constant(value='Ecuadorian Document %s must be like 001-001-123456789', kind='u')],
                                                    keywords=[],
                                                ),
                                                op=Mod(),
                                                right=Attribute(
