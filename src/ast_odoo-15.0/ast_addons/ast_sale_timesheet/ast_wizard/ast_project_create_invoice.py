        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='project.create.invoice', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Create Invoice from project', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                    name='default_get',
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='ProjectCreateInvoice', ctx=Load()),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='help',
                                value=Constant(value='Project to make billable', kind=None),
                            ),
                            keyword(
                                arg='required',
                ...
                Assign(
                    targets=[Name(id='_candidate_orders', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2many',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_candidate_orders', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Choose the Sales Order to invoice', kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                            ...
                            keyword(
                                arg='domain',
                                value=Constant(value="[('id', 'in', _candidate_orders)]", kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_amount_to_invoice', kind=None),
                            ),
                            keyword(
                                arg='currency_field',
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Total amount to invoice on the sales order, including all items (services, storables, expenses, ...)', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='sale_order_id.currency_id', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=True, kind=None),
                ...
                FunctionDef(
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Call(
                                                ...
                                                args=[Constant(value='tasks.sale_line_id.order_id', kind=None)],
                                                keywords=[],
                                            ),
                                            attr='filtered',
                                            ctx=Load(),
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='project_id.tasks.sale_line_id.order_id.invoice_status', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                                ...
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[Constant(value='The selected Sales Order should contain something to invoice.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
