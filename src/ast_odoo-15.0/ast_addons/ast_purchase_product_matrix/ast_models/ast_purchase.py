        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='If set, the matrix of configurable products will be shown on the report of this order.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                            ...
                            value=BoolOp(
                                ...
                                values=[
                                    ...
                                    Compare(
                                        ...
                                        ops=[Eq()],
                                        comparators=[Constant(value='grid', kind=None)],
                                    ),
                                ],
                            ),
                        ),
                    ...
                    body=[
                        If(
                            ...
                            body=[
                                ...
                                Assign(
                                    targets=[Name(id='default_po_line_vals', ctx=Store())],
                                                        ...
                                                        body=BoolOp(
                                                            ...
                                                            values=[
                                                                ...
                                                                Compare(
                                                                    ...
                                                                    ops=[Eq()],
                                                                    comparators=[Name(id='no_variant_attribute_values', ctx=Load())],
                                                                ),
                                                            ],
                                                        ),
                                                    ),
                                        ...
                                        If(
                                                                    ...
                                                                    exc=Call(
                                                                        ...
                                                                        args=[
                                                                            Call(
                                                                                ...
                                                                                args=[Constant(value='You cannot change the quantity of a product present in multiple purchase lines.', kind=None)],
                                                                                keywords=[],
                                                                            ),
                                                                        ],
                                                                        keywords=[],
                                            ...
                                            orelse=[
                                                If(
                                                    test=UnaryOp(
                                                        op=Not(),
                                                        operand=Name(id='default_po_line_vals', ctx=Load()),
                                                    ),
                                                    body=[
                                                        Assign(
                                                ...
                                                If(
                                                    ...
                                                    body=[
                                                        Assign(
                                                            targets=[
                                                                Subscript(
                                                                    value=Name(id='default_po_line_vals', ctx=Load()),
                                                            ...
                                                            Tuple(
                                                                elts=[
                                                                    ...
                                                                    Call(
                                                                        ...
                                                                        args=[Name(id='default_po_line_vals', ctx=Load())],
                                                                        keywords=[
                                                                            keyword(
                                                                                arg='product_id',
                                                                                value=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Reporting method.', kind=None),
                        ),
                        Assign(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Product attribute values that do not create variants', kind=None),
                            ),
                            keyword(
                                arg='ondelete',
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        For(
                            target=Name(id='no_variant_attribute_value', ctx=Store()),
                            iter=Attribute(
                                value=Name(id='self', ctx=Load()),
                                attr='product_no_variant_attribute_value_ids',
                                ctx=Load(),
                                    ...
                                    value=BinOp(
                                        left=BinOp(
                                            left=BinOp(
                                                ...
                                                right=Attribute(
                                                    value=Attribute(
                                                        value=Name(id='no_variant_attribute_value', ctx=Load()),
                                                        attr='attribute_id',
                                                        ctx=Load(),
                                                    ),
                                                    attr='name',
