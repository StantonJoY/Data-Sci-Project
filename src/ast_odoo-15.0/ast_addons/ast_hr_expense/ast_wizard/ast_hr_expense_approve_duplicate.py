        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='hr.expense.approve.duplicate', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Expense Approve Duplicate', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='sheet_ids', ctx=Store())],
                    value=Call(
                        func=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        If(
                            test=Compare(
                                left=Constant(value='sheet_ids', kind=None),
                                ops=[In()],
                                ...
                                Assign(
                                    targets=[
                                        Subscript(
                                            ...
                                            slice=Constant(value='sheet_ids', kind=None),
                                            ctx=Store(),
                                        ),
                                    ],
                                    value=List(
                        ...
                        If(
                            test=Compare(
                                left=Constant(value='duplicate_expense_ids', kind=None),
                                ops=[In()],
                                comparators=[Name(id='fields', ctx=Load())],
                            ),
                            body=[
                                Assign(
                                    targets=[
                                        Subscript(
                                            value=Name(id='res', ctx=Load()),
                                            slice=Constant(value='expense_ids', kind=None),
                                            ctx=Store(),
                                        ),
                                    ],
                                    value=List(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        ...
                                        args=[Constant(value='Duplicate Expense', kind=None)],
                                        keywords=[],
                                    ),
                                ],
                                keywords=[],
