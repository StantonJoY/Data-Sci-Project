        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='related',
                                value=Constant(value='employee_id.user_id', kind=None),
                            ),
                            keyword(
                                arg='store',
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Wizard action for sending a badge to a chosen employee', kind=None),
                        ),
                        If(
                            test=UnaryOp(
                                op=Not(),
                                    ...
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                ...
                                                args=[Constant(value='You can send badges only to employees linked to a user.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
                                ...
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[Constant(value='You can not send a badge to yourself.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
