                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='company_id.l10n_es_edi_certificate_ids', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='company_id.l10n_es_edi_tax_agency', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=False, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='company_id.l10n_es_edi_test_env', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=False, kind=None),
