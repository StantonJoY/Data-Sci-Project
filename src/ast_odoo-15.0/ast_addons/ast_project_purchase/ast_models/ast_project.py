    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='purchase_orders_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='# Purchase Orders', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_purchase_orders_count', kind=None),
                            ),
                            keyword(
                                arg='groups',
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='purchase_orders_data', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    ...
                                    List(
                                        elts=[
                                            Constant(value='account_analytic_id', kind=None),
                                            Constant(value='order_id:count_distinct', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    List(
                                        elts=[Constant(value='account_analytic_id', kind=None)],
                                        ctx=Load(),
                                    ),
                                ],
                                keywords=[],
                                    ...
                                    ListComp(
                                            ...
                                            elts=[
                                                Subscript(
                                                    value=Subscript(
                                                        ...
                                                        slice=Constant(value='account_analytic_id', kind=None),
                                                        ctx=Load(),
                                                    ),
                                        ...
                                        generators=[
                                            comprehension(
                                                ...
                                                iter=Name(id='purchase_orders_data', ctx=Load()),
                                                ifs=[],
                                                is_async=0,
                                            ),
                                        ],
                                ...
                                args=[
                                    List(
                                        elts=[
                                            Tuple(
                                                elts=[
                                                    Constant(value='order_line.account_analytic_id', kind=None),
                                                    Constant(value='!=', kind=None),
                                                    Constant(value=False, kind=None),
                                                ],
                                                ctx=Load(),
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    ...
                                                    Constant(value='action_open_project_purchase_orders', kind=None),
                                                    Compare(
                                                        left=Attribute(
                                                            value=Name(id='self', ctx=Load()),
                                                            attr='purchase_orders_count',
