Module(
    body=[
        ...
        Assign(
            targets=[Name(id='fakenow', ctx=Store())],
            value=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Name(id='fakenow', ctx=Load()),
                            type_comment=None,
                        ),
                    ],
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='cle-lunch-manager', kind=None),
                                    Constant(value='base.group_user,base.group_partner_manager,lunch.group_lunch_manager', kind=None),
                                ],
                                keywords=[],
                            ),
                            type_comment=None,
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[Constant(value='Farm 1', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='name', kind=None)],
                                                values=[Constant(value='Farm 2', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='name', kind=None)],
                                                values=[Constant(value='Pizza Inn', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='name', kind=None)],
                                                values=[Constant(value='Kothai', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    ...
                                                    Constant(value='America/New_York', kind=None),
                                                ],
                                            ),
                                        ],
                                        keywords=[],
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='name', kind=None)],
                                                values=[Constant(value='Coin Gourmand', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='name', kind=None)],
                                                values=[Constant(value='Pizza', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='name', kind=None)],
                                                values=[Constant(value='Sandwich', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Pizza', kind=None),
                                                    Attribute(
                                                        value=Attribute(
                                                            value=Name(id='self', ctx=Load()),
                                                            attr='category_pizza',
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Tuna Sandwich', kind=None),
                                                    Attribute(
                                                        value=Attribute(
                                                            value=Name(id='self', ctx=Load()),
                                                            attr='category_sandwich',
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Olives', kind=None),
                                            ...
                                            value=Call(
                                                ...
                                                args=[
                                                    Dict(
                                                        ...
                                                        values=[
                                                            Constant(value='New York UTC-5', kind=None),
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                            ...
                                            value=Call(
                                                ...
                                                args=[
                                                    Dict(
                                                        ...
                                                        values=[
                                                            Constant(value='Tokyo UTC+9', kind=None),
                                                            Constant(value='chat', kind=None),
                                        ...
                                        keywords=[
                                            keyword(
                                                arg='tz',
                                                value=Constant(value='Asia/Tokyo', kind=None),
                                            ),
                                        ],
                                    ),
                                    type_comment=None,
