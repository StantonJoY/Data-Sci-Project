        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='snailmail.letter.format.error', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Format Error Sending a Snailmail Letter', kind=None),
                    type_comment=None,
                ),
                Assign(
                    ...
                    body=[
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='snailmail_cover', kind=None)],
                                        values=[
                                            Attribute(
                                                value=Name(id='self', ctx=Load()),
                                                attr='snailmail_cover',
                        ...
                        For(
                            ...
                            iter=Name(id='letters_to_resend', ctx=Load()),
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='cover', kind=None)],
                                                values=[
                                                    Attribute(
                                                        value=Name(id='self', ctx=Load()),
                                                        attr='snailmail_cover',
