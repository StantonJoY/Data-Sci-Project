                        ...
                        Return(
                            value=Dict(
                                ...
                                values=[
                                    ...
                                    BinOp(
                                        left=Constant(value='/sale_quotation_builder/template/%d', kind=None),
                                        op=Mod(),
                                        right=Attribute(
                                            value=Name(id='self', ctx=Load()),
                                            attr='id',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='product_id.product_tmpl_id.quotation_only_description', kind=None),
                            ),
                            keyword(
                                arg='translate',
                                value=Name(id='html_translate', ctx=Load()),
                            ...
                            body=[
                                ...
                                Assign(
                                    targets=[
                                        Subscript(
                                            value=Name(id='values', ctx=Load()),
                                            slice=Constant(value='website_description', kind=None),
                                            ctx=Store(),
                                        ),
                                    ],
                                    value=Attribute(
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Name(id='super', ctx=Load()),
                                        args=[
                                            Name(id='SaleOrderTemplateOption', ctx=Load()),
                                            Name(id='self', ctx=Load()),
                                        ],
                                        keywords=[],
                                    ),
