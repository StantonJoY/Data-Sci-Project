        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestEditableQuant', ctx=Load()),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Product tracked by SN', kind=None),
                                            Constant(value='product', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=" Create a new quant who don't exist yet.\n        ", kind=None),
                        ),
                        Assign(
                        ...
                        Assign(
                            targets=[Name(id='stock_move', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Try to create a quant who already exist.\n        Must update the existing quant instead of creating a new one.\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='first_quant', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='second_quant', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='second_quant', ctx=Load()),
                                    attr='action_apply_inventory',
                                    ctx=Load(),
                                ),
                                args=[],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='first_quant', ctx=Load()),
                                        attr='quantity',
                                        ctx=Load(),
                                    ),
                                    Constant(value=24, kind=None),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        func=Name(id='len', ctx=Load()),
                                        args=[Name(id='stock_move', ctx=Load())],
                                        keywords=[],
                                    ),
                                    Constant(value=1, kind=None),
                                ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Try to create a quant with `inventory_quantity` but without applying it.\n        Creates two quants:\n          - One with `quantity` (this one must be OK)\n          - One with `inventory_quantity` (this one will have null quantity)\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='valid_quant', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='invalid_quant', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='valid_quant', ctx=Load()),
                                        attr='quantity',
                                        ctx=Load(),
                                    ),
                                    Constant(value=10, kind=None),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='invalid_quant', ctx=Load()),
                                        attr='quantity',
                                        ctx=Load(),
                                    ),
                                    Constant(value=0, kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='inventoried_quant', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='inventoried_quant', ctx=Load()),
                                    attr='action_apply_inventory',
                                    ctx=Load(),
                                ),
                                args=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Increases manually quantity of a quant.\n        ', kind=None),
                        ),
                        Assign(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Decreases manually quantity of a quant.\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='quant', ctx=Store())],
                            value=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Try to edit a record without the inventory mode.\n        Must raise an error.\n        ', kind=None),
                        ),
                        Assign(
                            targets=[
                                Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Checks that a warning is given when reusing an existing SN\n        in inventory mode.\n        ', kind=None),
                        ),
                        Assign(
                        ...
                        Assign(
                            targets=[Name(id='dupe_sn', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='dupe_sn', ctx=Load()),
                                    attr='action_apply_inventory',
                                    ctx=Load(),
                                ),
                                args=[],
