    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='website_sale_onboarding_payment_acquirer_state', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='State of the website sale onboarding payment acquirer step', kind=None),
                            ),
                            keyword(
                                arg='default',
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='website_sale.action_open_website_sale_onboarding_payment_acquirer_wizard', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
