    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='crm.lead.scoring.frequency', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Lead Scoring Frequency', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    targets=[Name(id='won_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Float',
                        ...
                        args=[Constant(value='Won Count', kind=None)],
                        keywords=[
                            keyword(
                                arg='digits',
                                value=Tuple(
                ...
                Assign(
                    targets=[Name(id='lost_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Float',
                        ...
                        args=[Constant(value='Lost Count', kind=None)],
                        keywords=[
                            keyword(
                                arg='digits',
                                value=Tuple(
        ...
        ClassDef(
            ...
            body=[
                Assign(
                    targets=[Name(id='_name', ctx=Store())],
                    value=Constant(value='crm.lead.scoring.frequency.field', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Fields that can be used for predictive lead scoring computation', kind=None),
                    type_comment=None,
                ),
                Assign(
