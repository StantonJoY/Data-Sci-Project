Module(
    body=[
        ...
        ClassDef(
            ...
            body=[
                Expr(
                    value=Constant(value='Represent the moderation rules for an email address in a group.', kind=None),
                ),
                Assign(
                    targets=[Name(id='_name', ctx=Store())],
                    value=Constant(value='mail.group.moderation', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Mailing List black/white list', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Always Allow', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Permanent Ban', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='default',
                                value=Constant(value='ban', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=List(
                        elts=[
                            Tuple(
                                elts=[
                                    Constant(value='mail_group_email_uniq', kind=None),
                                    Constant(value='UNIQUE(mail_group_id, email)', kind=None),
                                    Constant(value='You can create only one rule for a given email address in a group.', kind=None),
                                ],
                                ctx=Load(),
                            ),
                        ],
                        ...
                        For(
                            ...
                            body=[
                                ...
                                Assign(
                                    ...
                                    value=Name(id='email_normalized', ctx=Load()),
                                    type_comment=None,
                                ),
                            ],
                            orelse=[],
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='MailGroupModeration', ctx=Load()),
