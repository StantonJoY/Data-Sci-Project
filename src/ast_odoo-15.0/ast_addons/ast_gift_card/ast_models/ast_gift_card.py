            ...
            body=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Return(
                            value=BinOp(
                                left=Constant(value='044', kind=None),
                                op=Add(),
                                right=Subscript(
                                    value=Subscript(
                                        value=Call(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='help',
                                value=Constant(value='If empty, all users can use it', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='initial_amount', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Monetary',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_balance', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='expired_date', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Date',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='default',
                                value=Constant(value='valid', kind=None),
                            ),
                            keyword(
                                arg='copy',
                                value=Constant(value=False, kind=None),
                ...
                Assign(
                    ...
                    value=List(
                        elts=[
                            Tuple(
                                elts=[
                                    Constant(value='unique_gift_card_code', kind=None),
                                    Constant(value='UNIQUE(code)', kind=None),
                                    Constant(value='The gift card code must be unique.', kind=None),
                                ],
                                ctx=Load(),
                            ),
                            Tuple(
                                elts=[
                                    Constant(value='check_amount', kind=None),
                                    Constant(value='CHECK(initial_amount >= 0)', kind=None),
                                    Constant(value='The initial amount must be positive.', kind=None),
                                ],
                                ctx=Load(),
                            ),
                        ],
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Constant(value='Gift #%s', kind=None),
                                            Attribute(
                                                value=Name(id='record', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                        ...
                                        args=[
                                            List(
                                                elts=[
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            Constant(value='expired_date', kind=None),
                                                            Constant(value='<', kind=None),
                                                            Call(
                                                                func=Attribute(
                                                                    value=Attribute(
                ...
                FunctionDef(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='initial_amount', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
