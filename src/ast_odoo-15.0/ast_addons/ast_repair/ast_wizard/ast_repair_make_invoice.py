        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='repair.order.make_invoice', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Create Mass Invoice (repair)', kind=None),
                    type_comment=None,
                ),
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='Group by partner invoice address', kind=None)],
                        keywords=[],
                    ),
                    type_comment=None,
                ),
