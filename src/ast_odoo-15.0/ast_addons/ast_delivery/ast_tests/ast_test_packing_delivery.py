            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Product AW', kind=None),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Product BW', kind=None),
                                            Constant(value='product', kind=None),
                        ...
                        Assign(
                            targets=[Name(id='test_carrier_product', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Test carrier product', kind=None),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Test carrier', kind=None),
                                            Constant(value='fixed', kind=None),
                                            Attribute(
                                                value=Name(id='test_carrier_product', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                        ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=" Check that de default weight is correctly set by default when using the 'choose.delivery.package' wizard.\n        This purpose of this wizard is\n        ", kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='move_line_paw', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='move_line_pbw', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='pack_action', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='picking_ship', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='pack_action_ctx', ctx=Store())],
                            value=Subscript(
                                value=Name(id='pack_action', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='pack_action_model', ctx=Store())],
                            value=Subscript(
                                value=Name(id='pack_action', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Name(id='pack_action_model', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='pack_wiz', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                ...
                                                slice=Constant(value='choose.delivery.package', kind=None),
                                                ctx=Load(),
                                            ),
                                            attr='with_context',
                                            ctx=Load(),
                                        ),
                                        args=[Name(id='pack_action_ctx', ctx=Load())],
                                        keywords=[],
                                    ),
                                    attr='create',
                                    ctx=Load(),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='pack_wiz', ctx=Load()),
