                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Used when not being an url based menu', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Community Menu', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Menu Type', kind=None),
                            ),
                            keyword(
                                arg='required',
