            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='quant_vals', ctx=Store())],
                            value=Dict(
                                keys=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[Name(id='quant_vals', ctx=Load())],
                                keywords=[],
                            ),
                        ),
                        Assign(
                        ...
                        With(
                            items=[
                                withitem(
                                    ...
                                    optional_vars=Name(id='so_line', ctx=Store()),
                                ),
                            ],
                            body=[
                                Assign(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Subscript(
                                        value=Name(id='line_1', ctx=Load()),
                                        slice=Constant(value='replenishment_filled', kind=None),
                                        ctx=Load(),
                                    ),
                                ],
                                keywords=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' When accessing the report from a SO line, checks if the correct SO line is highlighted in the report\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='so_form', ctx=Store())],
                            value=Call(
                        ...
                        For(
                            ...
                            iter=List(
                                elts=[
                                    Name(id='so1', ctx=Load()),
                                    Name(id='so2', ctx=Load()),
                                ],
                                ctx=Load(),
                            ),
                            body=[
                                Assign(
                                    ...
                                    value=Dict(
                                        keys=[Constant(value='move_to_match_ids', kind=None)],
                                        values=[
                                            Attribute(
                                                value=Attribute(
                                                    value=Attribute(
                                    ...
                                    body=[
                                        If(
                                            test=Compare(
                                                ...
                                                ops=[Eq()],
                                                comparators=[Name(id='so', ctx=Load())],
                                            ),
                                            body=[
                                                Expr(
                                                    value=Call(
                                                        ...
                                                        args=[
                                                            ...
                                                            Constant(value='The corresponding SO line should be matched in the forecast report.', kind=None),
                                                        ],
                                                        keywords=[],
                                                    ),
                                                ),
                                                ...
                                                Expr(
                                                    value=Call(
                                                        ...
                                                        args=[
                                                            ...
                                                            Constant(value='A line of the forecast report not linked to the SO shoud not be matched.', kind=None),
                                                        ],
                                                        keywords=[],
                                                    ),
                                                ),
