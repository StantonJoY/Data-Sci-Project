        ...
        ClassDef(
            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=" The expense employee can't be able to create an expense for someone else.", kind=None),
                        ),
                        Assign(
                            targets=[Name(id='expense_employee_2', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='expense_employee_2', kind=None),
                                            Attribute(
                                                value=Attribute(
                                                    value=Attribute(
                                                        value=Name(id='self', ctx=Load()),
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Superboy costume washing', kind=None),
                                                    Attribute(
                                                        value=Name(id='expense_employee_2', ctx=Load()),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ),
                                                    Attribute(
                                ...
                                args=[
                                    ...
                                    List(
                                        elts=[
                                            Dict(
                                                keys=[Constant(value='state', kind=None)],
                                                values=[Constant(value='approve', kind=None)],
                                            ),
                                        ],
                                        ctx=Load(),
                                    ),
