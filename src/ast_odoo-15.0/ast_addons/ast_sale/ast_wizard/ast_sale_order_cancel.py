        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='Sales Order Cancel', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    targets=[Name(id='display_invoice_alert', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        args=[Constant(value='Invoice Alert', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_display_invoice_alert', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='disable_cancel_warning', kind=None)],
