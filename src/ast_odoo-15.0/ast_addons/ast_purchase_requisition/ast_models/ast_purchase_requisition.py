Module(
    body=[
        ...
        Assign(
            targets=[Name(id='PURCHASE_REQUISITION_STATES', ctx=Store())],
            value=List(
                elts=[
                    Tuple(
                        elts=[
                    ...
                    Tuple(
                        elts=[
                            Constant(value='ongoing', kind=None),
                            Constant(value='Ongoing', kind=None),
                        ],
                        ctx=Load(),
                    ),
                    ...
                    Tuple(
                        elts=[
                            ...
                            Constant(value='Bid Selection', kind=None),
                        ],
                        ctx=Load(),
                    ),
                    Tuple(
        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='purchase.requisition.type', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Agreement Type', kind=None),
                            ),
                            keyword(
                                arg='required',
                ...
                Assign(
                    ...
                    value=Call(
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Select only one RFQ (exclusive)', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Select multiple RFQ (non-exclusive)', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Agreement Selection Type', kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                            ...
                            keyword(
                                arg='default',
                                value=Constant(value='multiple', kind=None),
                            ),
                            keyword(
                                arg='help',
                                value=Constant(value='Select only one RFQ (exclusive):  when a purchase order is confirmed, cancel the remaining purchase order.\n\n                    Select multiple RFQ (non-exclusive): allows multiple purchase orders. On confirmation of a purchase order it does not cancel the remaining orders', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='quantity_copy', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Selection',
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Use quantities of agreement', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Set quantities manually', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Quantities', kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    targets=[Name(id='line_copy', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Selection',
                            ...
                            List(
                                elts=[
                                    Tuple(
                                        elts=[
                                            Constant(value='copy', kind=None),
                                            Constant(value='Use lines of agreement', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            Constant(value='none', kind=None),
                                            Constant(value='Do not create RfQ lines automatically', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='default',
                                value=Constant(value='copy', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Set active to false to hide the Purchase Agreement Types without removing it.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_orders_number', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='Number of Orders', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='purchase.requisition.type', kind=None)],
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Agreement Type', kind=None),
                            ...
                            keyword(
                                arg='default',
                                value=Name(id='_get_type_id', ctx=Load()),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='ordering_date', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Date',
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Ordering Date', kind=None),
                            ),
                            keyword(
                                arg='tracking',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Agreement Deadline', kind=None),
                            ),
                            keyword(
                                arg='tracking',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='The expected and scheduled delivery date where all the products are received', kind=None),
                            ),
                            keyword(
                                arg='tracking',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Products to Purchase', kind=None),
                            ),
                            keyword(
                                arg='states',
                                value=Dict(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='line_ids.product_id', kind=None),
                            ),
                            keyword(
                                arg='string',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            Name(id='PURCHASE_REQUISITION_STATES', ctx=Load()),
                ...
                Assign(
                    targets=[Name(id='state_blanket_order', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Selection',
                        ...
                        args=[Name(id='PURCHASE_REQUISITION_STATES', ctx=Load())],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_set_state', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='type_id.quantity_copy', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=True, kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        For(
                            target=Name(id='requisition', ctx=Store()),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='requisitions', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    List(
                                        elts=[
                                            ...
                                            Tuple(
                                                elts=[
                                                    Constant(value='type_id.quantity_copy', kind=None),
                                                    Constant(value='=', kind=None),
                                                    Constant(value='none', kind=None),
                                                ],
                                                ctx=Load(),
                        ...
                        If(
                            test=Call(
                                ...
                                args=[Name(id='requisitions', ctx=Load())],
                                keywords=[],
                            ),
                            body=[
                                Assign(
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        func=Name(id='_', ctx=Load()),
                                        args=[Constant(value='There is already an open blanket order for this supplier. We suggest you complete this open blanket order, instead of creating a new one.', kind=None)],
                                        keywords=[],
                                    ),
                                    type_comment=None,
                                ),
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='vendor_id', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                                            ...
                                            value=Call(
                                                ...
                                                keywords=[
                                                    keyword(
                                                        ...
                                                        value=Call(
                                                            func=Name(id='_', ctx=Load()),
                                                            args=[Constant(value='Cancelled by the agreement associated to this quotation.', kind=None)],
                                                            keywords=[],
                                                        ),
                                                    ),
                                                ],
                                    ...
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[
                                                    Constant(value="You cannot confirm agreement '%s' because there is no product line.", kind=None),
                                                    Attribute(
                                                        value=Name(id='self', ctx=Load()),
                                                        attr='name',
                                                        ctx=Load(),
                                                ...
                                                Raise(
                                                    exc=Call(
                                                        ...
                                                        args=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[Constant(value='You cannot confirm the blanket order without price.', kind=None)],
                                                                keywords=[],
                                                            ),
                                                        ],
                                                        keywords=[],
                                                ...
                                                Raise(
                                                    exc=Call(
                                                        ...
                                                        args=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[Constant(value='You cannot confirm the blanket order without quantity.', kind=None)],
                                                                keywords=[],
                                                            ),
                                                        ],
                                                        keywords=[],
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='state', kind=None)],
                                                values=[Constant(value='ongoing', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                    ...
                                    body=[
                                        Assign(
                                            ...
                                            value=Call(
                                                ...
                                                args=[Constant(value='purchase.requisition.purchase.tender', kind=None)],
                                                keywords=[],
                                            ),
                                            type_comment=None,
                                        ),
                                    ...
                                    orelse=[
                                        Assign(
                                            ...
                                            value=Call(
                                                ...
                                                args=[Constant(value='purchase.requisition.blanket.order', kind=None)],
                                                keywords=[],
                                            ),
                                            type_comment=None,
                                        ),
                            ...
                            test=Call(
                                ...
                                args=[
                                    GeneratorExp(
                                        ...
                                        generators=[
                                            comprehension(
                                                target=Name(id='purchase_order', ctx=Store()),
                                                iter=Call(
                                                    func=Attribute(
                                                        value=Name(id='self', ctx=Load()),
                                                        attr='mapped',
                                ...
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[Constant(value='You have to cancel or validate every RfQ before closing the purchase requisition.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
                                ...
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[Constant(value='You can only delete draft requisitions.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='PurchaseRequisition', ctx=Load()),
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_ordered_qty', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='Ordered Quantities', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='requisition_id.company_id', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='Company', kind=None),
                ...
                Assign(
                    targets=[Name(id='supplier_info_ids', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='One2many',
                        ...
                        args=[
                            ...
                            Constant(value='purchase_requisition_line_id', kind=None),
                        ],
                        keywords=[],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        If(
                            ...
                            body=[
                                Assign(
                                    targets=[Name(id='supplier_infos', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                                                ...
                                                GeneratorExp(
                                                    ...
                                                    generators=[
                                                        comprehension(
                                                            ...
                                                            iter=Name(id='supplier_infos', ctx=Load()),
                                                            ifs=[],
                                                            is_async=0,
                                                        ),
                                                    ],
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        If(
                            test=Compare(
                                left=Constant(value='price_unit', kind=None),
                                ops=[In()],
                            ...
                            body=[
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='price', kind=None)],
                                                values=[
                                                    Subscript(
                                                        value=Name(id='vals', ctx=Load()),
                                                        slice=Constant(value='price_unit', kind=None),
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[Constant(value='supplier_info_ids', kind=None)],
                                        keywords=[],
                                    ),
                                    attr='unlink',
                                    ctx=Load(),
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='purchase_requisition', ctx=Store())],
                            value=Attribute(
                                value=Name(id='self', ctx=Load()),
                                attr='requisition_id',
                                ctx=Load(),
                            ...
                            test=BoolOp(
                                ...
                                values=[
                                    Compare(
                                        left=Attribute(
                                            value=Attribute(
                                                value=Name(id='purchase_requisition', ctx=Load()),
                                                attr='type_id',
                                                ctx=Load(),
                                            ),
                                            attr='quantity_copy',
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='line_found', ctx=Store())],
                            value=Call(
                            ...
                            body=[
                                    ...
                                    iter=Call(
                                        ...
                                        args=[
                                            Lambda(
                                                args=arguments(
                                                    posonlyargs=[],
                                                    args=[arg(arg='purchase_order', annotation=None, type_comment=None)],
                                                    vararg=None,
                                                    kwonlyargs=[],
                                                    kw_defaults=[],
                                                    kwarg=None,
                                ...
                                If(
                                    test=Compare(
                                        ...
                                        ops=[NotIn()],
                                        comparators=[Name(id='line_found', ctx=Load())],
                                    ),
                                    body=[
                                        Assign(
                                            targets=[
                                        ...
                                        Expr(
                                            value=Call(
                                                func=Attribute(
                                                    value=Name(id='line_found', ctx=Load()),
                                                    attr='add',
                                                    ctx=Load(),
                                                ),
                                                args=[
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='requisition_id.purchase_ids.state', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                        ...
                        Return(
                            value=Dict(
                                keys=[
                                    ...
                                    Constant(value='account_analytic_id', kind=None),
