    ...
    body=[
        ...
        Try(
            ...
            handlers=[
                ExceptHandler(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='an2cn', ctx=Store())],
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='fapiao', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Fapiao Number', kind=None),
                            ),
                            keyword(
                                arg='size',
                ...
                FunctionDef(
                                            ...
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        ...
                                                        args=[Constant(value='Fapiao number is an 8-digit number. Please enter a correct one.', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='fapiao', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Convert number to ``amount in words`` for Chinese financial usage.', kind=None),
                        ),
                        If(
                            test=UnaryOp(
                                op=Not(),
                        ...
                        Return(
                            value=Call(
                                func=Name(id='an2cn', ctx=Load()),
                                args=[
                                    Name(id='number', ctx=Load()),
                                    Constant(value='rmb', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        If(
                            test=Name(id='statement_ids', ctx=Load()),
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
