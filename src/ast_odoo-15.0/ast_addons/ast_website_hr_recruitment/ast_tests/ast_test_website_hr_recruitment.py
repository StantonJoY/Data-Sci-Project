                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='A Test Job', kind=None),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='website_hr_recruitment_tour', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                                        ...
                                        elts=[
                                            Tuple(
                                                elts=[
                                                    ...
                                                    Constant(value='=', kind=None),
                                                    Constant(value='### HR RECRUITMENT TEST DATA ###', kind=None),
                                                ],
                                                ctx=Load(),
                                            ),
                                        ],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='118.218', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
