        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(lineno=8, col_offset=15, end_lineno=8, end_col_offset=43, value='l10n_in.product.hsn.report', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                    lineno=10,
                            ...
                            value=Call(
                                ...
                                func=Attribute(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Name(lineno=11, col_offset=25, end_lineno=11, end_col_offset=47, id='L10nInProductHsnReport', ctx=Load()),
                                            Name(lineno=11, col_offset=49, end_lineno=11, end_col_offset=53, id='self', ctx=Load()),
                                        ],
                                        keywords=[],
                                    ),
                                    attr='_from',
