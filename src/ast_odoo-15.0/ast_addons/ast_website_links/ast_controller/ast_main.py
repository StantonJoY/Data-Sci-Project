            ...
            body=[
                FunctionDef(
                            ...
                            body=[
                                Return(
                                    value=Dict(
                                        ...
                                        values=[Constant(value='empty_url', kind=None)],
                                    ),
                                ),
                            ],
                            orelse=[],
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/website_links/new', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
                    ...
                    body=[
                        Return(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='website_links.page_shorten_url', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                                                ...
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            Subscript(
                                                                value=Name(id='post', ctx=Load()),
                                                                slice=Constant(value='init_code', kind=None),
                                                                ctx=Load(),
                                                            ),
                                                        ],
                                                        ctx=Load(),
                                        ...
                                        elts=[
                                            Tuple(
                                                elts=[
                                                    ...
                                                    Subscript(
                                                        value=Name(id='post', ctx=Load()),
                                                        slice=Constant(value='new_code', kind=None),
                                                        ctx=Load(),
                                                    ),
                                                ],
                                                ctx=Load(),
                        ...
                        If(
                            test=Compare(
                                left=Name(id='new_code', ctx=Load()),
                                ops=[Gt()],
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/website_links/add_code', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
                                    value=Constant(value='json', kind=None),
                ...
                FunctionDef(
                        ...
                        Return(
                            value=Call(
                                ...
                                args=[
                                    Subscript(
                                        value=Name(id='post', ctx=Load()),
                                        slice=Constant(value='filter', kind=None),
                                        ctx=Load(),
                                    ),
                                    Subscript(
                                        value=Name(id='post', ctx=Load()),
                                        slice=Constant(value='limit', kind=None),
                                        ctx=Load(),
                                    ),
                                ],
                                keywords=[],
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/website_links/recent_links', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
                                    value=Constant(value='json', kind=None),
                            ...
                            body=[
                                Return(
                                    value=Call(
                                        ...
                                        args=[
                                            Constant(value='website_links.graphs', kind=None),
                                            Subscript(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Attribute(
