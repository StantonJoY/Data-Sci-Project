        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Dict(
                        keys=[Constant(value='mail.compose.message', kind=None)],
                        values=[Constant(value='composer_id', kind=None)],
                    ),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    targets=[Name(id='is_email', ctx=Store())],
                    value=Call(
                        func=Attribute(
                ...
                Assign(
                    targets=[Name(id='invoice_without_email', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Text',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_invoice_without_email', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='invoice(s) that will not be sent', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='is_print', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                ...
                Assign(
                    targets=[Name(id='printed', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        args=[Constant(value='Is Printed', kind=None)],
                        keywords=[
                            keyword(
                                arg='default',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='account_move_account_invoice_send_rel', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='string',
                ...
                Assign(
                    targets=[Name(id='composer_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                        ...
                        args=[Constant(value='mail.compose.message', kind=None)],
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Composer', kind=None),
                            ),
                            keyword(
                                arg='required',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Move types', kind=None),
                            ),
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_move_types', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=True, kind=None),
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Technical field containing a textual representation of the selected move types, if multiple. It is used to inform the user in the window in such case.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                                    ...
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                ...
                                                args=[Constant(value='You can only send invoices.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
                                ...
                                args=[
                                    Dict(
                                        keys=[
                                            ...
                                            Constant(value='composer_id', kind=None),
                                        ],
                                        values=[
                            ...
                            body=[
                                ...
                                If(
                                    ...
                                    body=[
                                        ...
                                        Assign(
                                            targets=[Name(id='move_types_set', ctx=Store())],
                                            value=Call(
                                        ...
                                        If(
                                            test=Compare(
                                                left=Call(
                                                    func=Name(id='len', ctx=Load()),
                                                    args=[Name(id='move_types_set', ctx=Load())],
                                                    keywords=[],
                                                ),
                                                ops=[Gt()],
                                                comparators=[Constant(value=1, kind=None)],
                                ...
                                Assign(
                                    ...
                                    value=Name(id='move_types', ctx=Load()),
                                    type_comment=None,
                                ),
                            ],
                            orelse=[],
                ...
                FunctionDef(
                                ...
                                If(
                                    test=UnaryOp(
                                        ...
                                        operand=Call(
                                            ...
                                            args=[Constant(value='wizard_opened', kind=None)],
                                            keywords=[],
                                        ),
                                    ),
                                    body=[
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='is_email', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                                                    ...
                                                    value=BinOp(
                                                        ...
                                                        right=Tuple(
                                                            elts=[
                                                                Call(
                                                                    func=Name(id='_', ctx=Load()),
                                                                    args=[Constant(value="The following invoice(s) will not be sent by email, because the customers don't have email address.", kind=None)],
                                                                    keywords=[],
                                                                ),
                                                                Call(
                                                                    func=Attribute(
                            ...
                            body=[
                                ...
                                If(
                                    test=Call(
                                        ...
                                        args=[Constant(value='mark_invoice_as_sent', kind=None)],
                                        keywords=[],
                                    ),
                                    body=[
                                        Expr(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' to override for each type of models that will use this composer.', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='close_on_report_download', kind=None)],
                                        values=[Constant(value=True, kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ...
                            body=[
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[Constant(value='partner_id.lang', kind=None)],
                                        keywords=[],
                                    ),
                                    type_comment=None,
                                ),
                                Assign(
                                    targets=[Name(id='default_lang', ctx=Store())],
                                    value=Call(
                                ...
                                For(
                                    ...
                                    iter=BoolOp(
                                        ...
                                        values=[
                                            ...
                                            List(
                                                elts=[Name(id='default_lang', ctx=Load())],
                                                ctx=Load(),
                                            ),
                                        ],
                                    ),
                                    body=[
                                        Assign(
                                            targets=[Name(id='active_ids_lang', ctx=Store())],
                                            value=Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Name(id='active_records', ctx=Load()),
                                                    ...
                                                    args=[
                                                        Lambda(
                                                            ...
                                                            body=Compare(
                                                                ...
                                                                ops=[Eq()],
                                                                comparators=[Name(id='lang', ctx=Load())],
                                                            ),
                                                        ),
                                                    ],
                                                    keywords=[],
                                        ...
                                        Assign(
                                            targets=[Name(id='self_lang', ctx=Store())],
                                            value=Call(
                                                func=Attribute(
                                                    value=Name(id='self', ctx=Load()),
                                                    attr='with_context',
                                                ...
                                                keywords=[
                                                    keyword(
                                                        arg='active_ids',
                                                        value=Name(id='active_ids_lang', ctx=Load()),
                                                    ),
                                                    keyword(
                                                        arg='lang',
                                        ...
                                        Expr(
                                            value=Call(
                                                func=Attribute(
                                                    value=Name(id='self_lang', ctx=Load()),
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[Constant(value='Send Invoice', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                    ),
