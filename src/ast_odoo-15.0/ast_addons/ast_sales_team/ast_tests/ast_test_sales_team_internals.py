        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestCornerCases', ctx=Load()),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                keywords=[
                                    keyword(
                                        arg='login',
                                        value=Constant(value='user_sales_leads', kind=None),
                                    ),
                                    keyword(
                                        arg='name',
                                        value=Constant(value='Laetitia Sales Leads', kind=None),
                                    ),
                                    keyword(
                                        arg='email',
                                        value=Constant(value='crm_leads@test.example.com', kind=None),
                                    ),
                                    keyword(
                                        arg='company_id',
                                        value=Attribute(
                                    ...
                                    keyword(
                                        arg='groups',
                                        value=Constant(value='sales_team.group_sale_salesman_all_leads,base.group_partner_manager', kind=None),
                                    ),
                                ],
                            ),
                            type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='sales_team_1_m1', ctx=Load()),
                                    attr='write',
                                    ctx=Load(),
                                ),
                                args=[
                        ...
                        Assign(
                            targets=[Name(id='sales_team_1_m2', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Name(id='sales_team_1_m2', ctx=Load()),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Test constraint works with creating duplicates in the same create\n        method. ', kind=None),
                        ),
                        With(
                            items=[
                                withitem(
        ...
        ClassDef(
            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='sales_team', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='sales_team', ctx=Load()),
                                    attr='read',
                                    ctx=Load(),
                                ),
                                args=[
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[Constant(value='Trolling', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
