            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestStockLandedCostsMrp', ctx=Load()),
                                ...
                                value=Call(
                                    ...
                                    args=[
                                        Dict(
                                            ...
                                            values=[Constant(value='My Test Supplier', kind=None)],
                                        ),
                                    ],
                                    keywords=[],
                                ),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Refrigerator', kind=None),
                                            Constant(value='product', kind=None),
                                            Attribute(
                                                value=Attribute(
                                                    value=Name(id='cls', ctx=Load()),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Adviser', kind=None),
                                            Constant(value='fm', kind=None),
                                            Constant(value='accountmanager@yourcompany.com', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='landed_cost', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Name(id='Form', ctx=Load()),
                        ...
                        Assign(
                            ...
                            value=Constant(value='manufacturing', kind=None),
                            type_comment=None,
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Compare(
                                        left=Name(id='man_order', ctx=Load()),
                                        ops=[In()],
                                        comparators=[
                                            Call(
                                                func=Attribute(
                                                ...
                                                args=[
                                                    List(
                                                        elts=[
                                                            Tuple(
                                                                elts=[
                                                                    Constant(value='move_finished_ids.stock_valuation_layer_ids', kind=None),
