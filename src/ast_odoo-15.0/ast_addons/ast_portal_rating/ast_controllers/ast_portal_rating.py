                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        args=[
                            ...
                            arg(arg='rating_id', annotation=None, type_comment=None),
                            arg(arg='publisher_comment', annotation=None, type_comment=None),
                        ],
                        vararg=None,
                        kwonlyargs=[],
                        kw_defaults=[],
                    ...
                    body=[
                                            ...
                                            Tuple(
                                                elts=[
                                                    ...
                                                    Call(
                                                        ...
                                                        args=[Name(id='rating_id', ctx=Load())],
                                                        keywords=[],
                                                    ),
                                                ],
                                                ctx=Load(),
                                    ...
                                    value=Dict(
                                        ...
                                        values=[
                                            Call(
                                                ...
                                                args=[Constant(value='Invalid rating', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                    ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='publisher_comment', kind=None)],
                                        values=[Name(id='publisher_comment', ctx=Load())],
                                    ),
                                ],
                                keywords=[],
                            ),
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[
                                List(
                                    elts=[Constant(value='/website/rating/comment', kind=None)],
                                    ctx=Load(),
                                ),
                            ],
                            keywords=[
