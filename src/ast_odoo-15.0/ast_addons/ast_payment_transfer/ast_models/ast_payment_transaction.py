        ...
        ClassDef(
            ...
            body=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Override of payment to return Transfer-specific rendering values.\n\n        Note: self.ensure_one() from `_get_processing_values`\n\n        :param dict processing_values: The generic and specific processing values of the transaction\n        :return: The dict of acquirer-specific processing values\n        :rtype: dict\n        ', kind=None),
                        ),
                        Assign(
                        ...
                        Return(
                            value=Dict(
                                ...
                                values=[
                                    Attribute(
                                        value=Name(id='TransferController', ctx=Load()),
                                        attr='_accept_url',
                                        ctx=Load(),
                                    ),
                                    Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Override of payment to find the transaction based on transfer data.\n\n        :param str provider: The provider of the acquirer that handled the transaction\n        :param dict data: The transfer feedback data\n        :return: The transaction if found\n        :rtype: recordset of `payment.transaction`\n        :raise: ValidationError if the data match no transaction\n        ', kind=None),
                        ),
                        Assign(
                            ...
                            body=[
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            BinOp(
                                                left=Constant(value='Wire Transfer: ', kind=None),
                                                op=Add(),
                                                right=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Override of payment to process the transaction based on transfer data.\n\n        Note: self.ensure_one()\n\n        :param dict data: The transfer feedback data\n        :return: None\n        ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='validated transfer payment for tx with reference %s: set as pending', kind=None),
                                    Attribute(
                                        value=Name(id='self', ctx=Load()),
                                        attr='reference',
                                        ctx=Load(),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Override of payment to remove transfer acquirer from the recordset.\n\n        :return: None\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='other_provider_txs', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='filtered',
                                ...
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            ...
                                            Name(id='other_provider_txs', ctx=Load()),
                                        ],
                                        keywords=[],
                                    ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=" Override of payment to return a different message.\n\n        :return: The 'transaction sent' message\n        :rtype: str\n        ", kind=None),
                        ),
                        Assign(
                        ...
                        If(
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Call(
                                        func=Name(id='_', ctx=Load()),
                                        args=[Constant(value='The customer has selected %(acq_name)s to make the payment.', kind=None)],
                                        keywords=[
                                            keyword(
                                                arg='acq_name',
                                                value=Attribute(
