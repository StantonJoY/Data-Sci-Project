Module(
    body=[
        ...
        ClassDef(
            name='MicrosoftCalendarController',
            bases=[
                Attribute(
                ...
                FunctionDef(
                                ...
                                If(
                                    ...
                                    body=[
                                        ...
                                        If(
                                            test=Call(
                                                func=Attribute(
                                                    value=Name(id='MicrosoftCal', ctx=Load()),
                                                    attr='_can_authorize_microsoft',
                                                    ctx=Load(),
                                                ),
                                                args=[
                                                    Attribute(
                                    ...
                                    body=[
                                        Assign(
                                            ...
                                            value=Call(
                                                func=Attribute(
                                                    value=Name(id='MicrosoftCal', ctx=Load()),
                                                    attr='_microsoft_authentication_url',
                                                    ctx=Load(),
                                                ),
                                                args=[],
                                                keywords=[
                                    ...
                                    value=Dict(
                                        ...
                                        values=[
                                            IfExp(
                                                ...
                                                orelse=Constant(value='no_new_event_from_microsoft', kind=None),
                                            ),
                                            Constant(value='', kind=None),
                                        ],
                                    ),
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/microsoft_calendar/sync_data', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
