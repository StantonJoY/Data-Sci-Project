                    ...
                    body=[
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='/web#action=test_new_api.action_discussions', kind=None),
                                    Constant(value='widget_x2many', kind=None),
                                ],
                                keywords=[
                                    keyword(
                                        arg='step_delay',
                    ...
                    body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[Constant(value='base.module_test_new_api', kind=None)],
                                        keywords=[],
                                    ),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='test_new_api.constraint_test_new_api_category_positive_color', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='La couleur doit être une valeur positive !', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='/web#action=test_new_api.action_categories', kind=None),
                                    Constant(value='sql_constaint', kind=None),
                                ],
                                keywords=[
                                    keyword(
                                        arg='login',
