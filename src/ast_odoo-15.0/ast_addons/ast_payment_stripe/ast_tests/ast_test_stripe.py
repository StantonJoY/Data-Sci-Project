Module(
    body=[
        ...
        ClassDef(
            name='StripeTest',
            bases=[Name(id='StripeCommon', ctx=Load())],
            keywords=[],
            body=[
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='dummy_session_id', ctx=Store())],
                            value=Constant(value='cs_test_sbTG0yGwTszAqFUP8Ulecr1bUwEyQEo29M8taYvdP7UA6Qr37qX6uA6w', kind=None),
                            type_comment=None,
                        ),
                        Assign(
                            ...
                            body=[
                                Return(
                                    value=Dict(
                                        ...
                                        values=[Name(id='dummy_session_id', ctx=Load())],
                                    ),
                                ),
                            ],
                            decorator_list=[],
                                ...
                                withitem(
                                    context_expr=Call(
                                        ...
                                        args=[
                                            ...
                                            Constant(value='_stripe_create_checkout_session', kind=None),
                                            Name(id='mock_stripe_create_checkout_session', ctx=Load()),
                                        ],
                                        keywords=[],
                                    ),
                                    optional_vars=None,
                            ...
                            value=Call(
                                ...
                                args=[
                                    Subscript(
                                        ...
                                        slice=Constant(value='publishable_key', kind=None),
                                        ctx=Load(),
                                    ),
                                    Attribute(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Name(id='dummy_session_id', ctx=Load()),
                                ],
                                keywords=[],
                            ),
                        ),
