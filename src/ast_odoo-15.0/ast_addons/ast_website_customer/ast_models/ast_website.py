                                    ...
                                    Tuple(
                                        ...
                                        elts=[
                                            Call(
                                                ...
                                                args=[Constant(lineno=13, col_offset=40, end_lineno=13, end_col_offset=52, value='References', kind=None)],
                                                keywords=[],
                                            ),
                                            Call(
                                                lineno=13,
                                                ...
                                                end_lineno=13,
                                                end_col_offset=76,
                                                func=Name(lineno=13, col_offset=55, end_lineno=13, end_col_offset=62, id='url_for', ctx=Load()),
                                                args=[Constant(lineno=13, col_offset=63, end_lineno=13, end_col_offset=75, value='/customers', kind=None)],
                                                keywords=[],
                                            ),
                                            Constant(lineno=13, col_offset=78, end_lineno=13, end_col_offset=96, value='website_customer', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
