        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='snailmail.confirm', kind=None),
                    type_comment=None,
                ),
                Assign(
                        ...
                        Return(
                            value=UnaryOp(
                                ...
                                operand=Call(
                                    ...
                                    args=[
                                        BinOp(
                                            left=Constant(value='%s.warning_shown', kind=None),
                                            op=Mod(),
                                            right=Attribute(
                                                value=Name(id='self', ctx=Load()),
                                                attr='_name',
                    ...
                    body=[
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='snailmail.snailmail_confirm_view', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
