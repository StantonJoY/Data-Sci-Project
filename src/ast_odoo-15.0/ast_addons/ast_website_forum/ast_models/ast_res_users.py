    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='forum_waiting_posts_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Integer',
                        ...
                        args=[Constant(value='Waiting post', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_get_user_waiting_post', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='See our Forum', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
