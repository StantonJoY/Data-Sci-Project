                                ...
                                Assign(
                                    ...
                                    value=Attribute(
                                        value=Call(
                                            ...
                                            args=[Constant(value='l10n_de.tag_de_asset_bs_B_III_2', kind=None)],
                                            keywords=[],
                                        ),
                                        attr='id',
                                        ctx=Load(),
                                                ...
                                                values=[
                                                    Attribute(
                                                        value=Call(
                                                            ...
                                                            args=[Constant(value='l10n_de.external_layout_din5008', kind=None)],
                                                            keywords=[],
                                                        ),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ...
                                                    Attribute(
                                                        value=Call(
                                                            ...
                                                            args=[Constant(value='l10n_de.paperformat_euro_din', kind=None)],
                                                            keywords=[],
                                                        ),
                                                        attr='id',
                                                        ctx=Load(),
