        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='Scrap', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='Scrap Move', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='readonly',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='domain',
                                value=Constant(value="[('usage', '=', 'internal'), ('company_id', 'in', [company_id, False])]", kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                            ...
                            keyword(
                                arg='default',
                                value=Name(id='_get_default_location_id', ctx=Load()),
                            ),
                            keyword(
                                arg='check_company',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    targets=[Name(id='scrap_location_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                        ...
                        args=[
                            Constant(value='stock.location', kind=None),
                            Constant(value='Scrap Location', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='default',
                                value=Name(id='_get_default_scrap_location_id', ctx=Load()),
                            ),
                            keyword(
                                arg='domain',
                                value=Constant(value="[('scrap_location', '=', True), ('company_id', 'in', [company_id, False])]", kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    targets=[Name(id='scrap_qty', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Float',
                                ...
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[Constant(value='You cannot delete a scrap which is done.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
                        ...
                        Return(
                            value=Dict(
                                keys=[
                                    ...
                                    Constant(value='scrapped', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        For(
                            target=Name(id='scrap', ctx=Store()),
                                    ...
                                    value=BoolOp(
                                        ...
                                        values=[
                                            Call(
                                                ...
                                                args=[Constant(value='stock.scrap', kind=None)],
                                                keywords=[],
                                            ),
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                        ...
                                        args=[
                                            Dict(
                                                keys=[
                                                    ...
                                                    Constant(value='default_scrap_id', kind=None),
                                    ...
                                    value=Dict(
                                        ...
                                        values=[
                                            BinOp(
                                                ...
                                                right=Call(
                                                    func=Name(id='_', ctx=Load()),
                                                    args=[Constant(value=': Insufficient Quantity To Scrap', kind=None)],
                                                    keywords=[],
                                                ),
                                            ),
                                            Constant(value='form', kind=None),
                                            Constant(value='stock.warn.insufficient.qty.scrap', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Attribute(
                                                    ...
                                                    args=[Constant(value='stock.stock_warn_insufficient_qty_scrap_form_view', kind=None)],
                                                    keywords=[],
                                                ),
                                                attr='id',
                                                ctx=Load(),
