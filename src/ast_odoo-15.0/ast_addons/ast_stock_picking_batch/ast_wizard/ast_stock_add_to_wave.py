        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='stock.add.to.wave', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Wave Transfer Lines', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                    name='default_get',
                                    ...
                                    body=[
                                        ...
                                        Assign(
                                            targets=[
                                                Subscript(
                                                    value=Name(id='res', ctx=Load()),
                                                    slice=Constant(value='picking_ids', kind=None),
                                                    ctx=Store(),
                                                ),
                                            ],
                                            value=Call(
                                    ...
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                ...
                                                args=[Constant(value='The selected transfers should belong to the same operation type', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
                ...
                Assign(
                    targets=[Name(id='wave_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Wave Transfer', kind=None),
                            ),
                            keyword(
                                arg='domain',
                                value=Constant(value="[('is_wave', '=', True), ('state', '!=', 'done')]", kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='an existing wave transfer', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='a new wave transfer', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Person responsible for this wave transfer', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                                        ...
                                        Raise(
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        func=Name(id='_', ctx=Load()),
                                                        args=[Constant(value='The selected operations should belong to a unique company.', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
                                        ...
                                        Raise(
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        func=Name(id='_', ctx=Load()),
                                                        args=[Constant(value='The selected transfers should belong to a unique company.', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
                                ...
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Name(id='_', ctx=Load()),
                                                args=[Constant(value='Cannot create wave transfers', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
