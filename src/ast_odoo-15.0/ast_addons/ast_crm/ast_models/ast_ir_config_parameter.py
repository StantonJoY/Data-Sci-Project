        ...
        ClassDef(
            ...
            body=[
                                ...
                                args=[
                                    GeneratorExp(
                                        elt=Compare(
                                            ...
                                            ops=[Eq()],
                                            comparators=[Constant(value='crm.pls_fields', kind=None)],
                                        ),
                                        generators=[
                                            comprehension(
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='pls_emptied', ctx=Store())],
                            value=Call(
                                func=Name(id='any', ctx=Load()),
                                args=[
                                    GeneratorExp(
                        ...
                        If(
                            test=Name(id='pls_emptied', ctx=Load()),
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
                        ...
                        Return(
                            value=Name(id='pls_emptied', ctx=Load()),
                        ),
                    ],
                    decorator_list=[],
                    returns=None,
