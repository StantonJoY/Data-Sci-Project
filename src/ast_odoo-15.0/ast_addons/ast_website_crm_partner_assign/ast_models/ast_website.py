                                    ...
                                    Tuple(
                                        ...
                                        elts=[
                                            Call(
                                                ...
                                                args=[Constant(lineno=13, col_offset=40, end_lineno=13, end_col_offset=51, value='Resellers', kind=None)],
                                                keywords=[],
                                            ),
                                            Call(
                                                lineno=13,
                                                ...
                                                end_lineno=13,
                                                end_col_offset=74,
                                                func=Name(lineno=13, col_offset=54, end_lineno=13, end_col_offset=61, id='url_for', ctx=Load()),
                                                args=[Constant(lineno=13, col_offset=62, end_lineno=13, end_col_offset=73, value='/partners', kind=None)],
                                                keywords=[],
                                            ),
                                            Constant(lineno=13, col_offset=76, end_lineno=13, end_col_offset=104, value='website_crm_partner_assign', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
