                        ...
                        Assign(
                            ...
                            targets=[
                                Subscript(
                                    ...
                                    slice=Constant(lineno=13, col_offset=12, end_lineno=13, end_col_offset=28, value='check_printing', kind=None),
                                    ctx=Store(),
                                ),
                            ],
                            value=Dict(
                                ...
                                end_col_offset=84,
                                keys=[
                                    Constant(lineno=13, col_offset=33, end_lineno=13, end_col_offset=39, value='mode', kind=None),
                                    Constant(lineno=13, col_offset=50, end_lineno=13, end_col_offset=58, value='domain', kind=None),
                                ],
                                values=[
                                    Constant(lineno=13, col_offset=41, end_lineno=13, end_col_offset=48, value='multi', kind=None),
                                    List(
                                        lineno=13,
                                        col_offset=60,
                                        end_lineno=13,
                                        ...
                                        elts=[
                                            Tuple(
                                                ...
                                                end_col_offset=82,
                                                elts=[
                                                    Constant(lineno=13, col_offset=62, end_lineno=13, end_col_offset=68, value='type', kind=None),
                                                    Constant(lineno=13, col_offset=70, end_lineno=13, end_col_offset=73, value='=', kind=None),
                                                    Constant(lineno=13, col_offset=75, end_lineno=13, end_col_offset=81, value='bank', kind=None),
                                                ],
                                                ctx=Load(),
                                            ),
                                        ],
