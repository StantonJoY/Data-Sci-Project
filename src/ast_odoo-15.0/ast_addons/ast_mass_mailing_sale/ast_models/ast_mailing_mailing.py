    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='sale_quotation_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_sale_quotation_count', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='sale_invoiced_amount', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Integer',
                        ...
                        args=[Constant(value='Invoiced Amount', kind=None)],
                        keywords=[
                            keyword(
                                arg='groups',
                                value=Constant(value='sales_team.group_sale_salesman', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='has_so_access', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        If(
                            test=UnaryOp(
                                op=Not(),
                                operand=Name(id='has_so_access', ctx=Load()),
                            ),
                            body=[
                                Assign(
                                    targets=[
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='mailing_domain', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            ...
                                            List(
                                                elts=[Constant(value='amount_untaxed_signed', kind=None)],
                                                ctx=Load(),
                                            ),
                                        ],
                                        keywords=[],
                                        ...
                                        args=[
                                            GeneratorExp(
                                                elt=Subscript(
                                                    ...
                                                    slice=Constant(value='amount_untaxed_signed', kind=None),
                                                    ctx=Load(),
                                                ),
                                                generators=[
                                                    comprehension(
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='self_with_company', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='with_company',
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='self_with_company', ctx=Load()),
                                        attr='sale_invoiced_amount',
                                        ctx=Load(),
                                    ),
                        ...
                        Assign(
                            targets=[
                                Subscript(
                                    ...
                                    slice=Constant(value='kpi_col2', kind=None),
                                    ctx=Store(),
                                ),
                            ],
                            value=Dict(
                                ...
                                values=[
                                    ...
                                    Call(
                                        ...
                                        args=[Constant(value='QUOTATIONS', kind=None)],
                                        keywords=[],
                                    ),
                                ],
                            ),
                        ...
                        Assign(
                            targets=[
                                Subscript(
                                    ...
                                    slice=Constant(value='kpi_col3', kind=None),
                                    ctx=Store(),
                                ),
                            ],
                            value=Dict(
