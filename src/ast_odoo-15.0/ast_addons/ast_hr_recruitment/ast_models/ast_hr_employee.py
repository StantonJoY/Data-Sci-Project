    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='newly_hired_employee', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='Newly hired employee', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_newly_hired_employee', kind=None),
                            ),
                            keyword(
                                arg='search',
                                value=Constant(value='_search_newly_hired_employee', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='Applicant', kind=None),
                        ],
                        keywords=[],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='new_employee', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                        ...
                        If(
                            test=Attribute(
                                value=Name(id='new_employee', ctx=Load()),
                                attr='applicant_id',
                                ctx=Load(),
                            ),
                            body=[
                                Expr(
                                    value=Call(
                                        ...
                                        args=[Constant(value='hr_recruitment.applicant_hired_template', kind=None)],
                                        keywords=[
                                            keyword(
                                                arg='values',
                                                value=Dict(
                                                    keys=[Constant(value='applicant', kind=None)],
                                                    values=[
                                                        Attribute(
                                                            value=Name(id='new_employee', ctx=Load()),
                                                            attr='applicant_id',
                                            ...
                                            keyword(
                                                ...
                                                value=Attribute(
                                                    value=Call(
                                                        ...
                                                        args=[Constant(value='hr_recruitment.mt_applicant_hired', kind=None)],
                                                        keywords=[],
                                                    ),
                                                    attr='id',
                                                    ctx=Load(),
