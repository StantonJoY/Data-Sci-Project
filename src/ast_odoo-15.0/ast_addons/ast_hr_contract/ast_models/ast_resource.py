            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='# Contracts using it', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                            ...
                            keyword(
                                arg='groups',
                                value=Constant(value='hr_contract.group_hr_contract_manager', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        args=[
                            ...
                            arg(arg='other_calendar', annotation=None, type_comment=None),
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='domain', ctx=Store())],
                            value=IfExp(
                                test=Name(id='resources', ctx=Load()),
                                body=Call(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='calendar_id', kind=None)],
                                        values=[
                                            Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='mapped_counts', ctx=Store())],
                            value=DictComp(
                                key=Subscript(
                                    value=Subscript(
                                        value=Name(id='cd', ctx=Load()),
                                ...
                                value=Subscript(
                                    value=Name(id='cd', ctx=Load()),
                                    slice=Constant(value='resource_calendar_id_count', kind=None),
                                    ctx=Load(),
                                ),
                                generators=[
                                    comprehension(
                                        target=Name(id='cd', ctx=Store()),
                        ...
                        For(
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='mapped_counts', ctx=Load()),
                                            attr='get',
                                            ctx=Load(),
                                        ),
                                        args=[
                    ...
                    body=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='domain', kind=None)],
                                        values=[
                                            List(
                                                elts=[
                                                    Tuple(
