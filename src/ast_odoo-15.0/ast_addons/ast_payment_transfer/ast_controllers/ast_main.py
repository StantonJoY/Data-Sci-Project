Module(
    body=[
        ...
        ClassDef(
            ...
            body=[
                Assign(
                    targets=[Name(id='_accept_url', ctx=Store())],
                    value=Constant(value='/payment/transfer/feedback', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='beginning _handle_feedback_data with post data %s', kind=None),
                                    Call(
                                        func=Attribute(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Name(id='_accept_url', ctx=Load())],
                            keywords=[
                                keyword(
                                    arg='type',
