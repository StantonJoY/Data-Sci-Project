    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='spoken_languages', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Char',
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Spoken Languages', kind=None),
                            ),
                            keyword(
                                arg='help',
                                value=Constant(value="State here the languages for which the translations of templates could be loaded at the time of installation of this localization module and copied in the final object when generating them from templates. You must provide the language codes separated by ';'", kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
