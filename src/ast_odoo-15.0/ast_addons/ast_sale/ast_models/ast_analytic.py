        ...
        ClassDef(
            ...
            body=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' This is only used for delivered quantity of SO line based on analytic line, and timesheet\n            (see sale_timesheet). This can be override to allow further customization.\n        ', kind=None),
                        ),
                        Return(
                            value=List(
                                elts=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Sales Order Item', kind=None),
                            ),
                            keyword(
                                arg='domain',
                                value=Lambda(
