                    ...
                    body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='OtherEvent', kind=None),
                        ...
                        Assign(
                            targets=[
                                List(
                                    elts=[
                                        Name(id='main_visitor', ctx=Store()),
                                        Name(id='child_visitor', ctx=Store()),
                                    ],
                                    ctx=Store(),
                                ),
                            ],
                                    ...
                                    List(
                                        elts=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Main Visitor', kind=None),
                                                    List(
                                                        elts=[
                                                            Tuple(
                                                                elts=[
                                            ...
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Child Visitor', kind=None),
                                                    List(
                                                        elts=[
                                                            Tuple(
                                                                elts=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Name(id='event_1', ctx=Load()),
                                    Attribute(
                                        value=Name(id='child_visitor', ctx=Load()),
                                        attr='event_registered_ids',
                                        ctx=Load(),
                                    ),
                                ],
                                        ...
                                        args=[
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                                            Constant(value='event_registered_ids', kind=None),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Name(id='child_visitor', ctx=Load()),
                                    Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    BinOp(
                                        ...
                                        op=BitOr(),
                                        right=Name(id='event_1', ctx=Load()),
                                    ),
                                    Attribute(
                                        value=Name(id='main_visitor', ctx=Load()),
                                        attr='event_registered_ids',
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    BinOp(
                                        left=Name(id='main_visitor', ctx=Load()),
                                        op=BitOr(),
                                        right=Name(id='child_visitor', ctx=Load()),
                                    ),
                                    Call(
                                        func=Attribute(
                                            value=Call(
