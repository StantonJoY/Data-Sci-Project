        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Workcenter', kind=None),
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='product', kind=None),
                                            Constant(value=233.0, kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    Constant(value='work work', kind=None),
                                                                    Attribute(
                                                                        value=Attribute(
                                                                            value=Name(id='cls', ctx=Load()),
                                                                            attr='workcenter',
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Test the amount on analytic line will change when consumed qty of the\n        component changed.\n        ', kind=None),
                        ),
                        Assign(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Test the analytic lines are correctly posted when backorder.\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='mo_form', ctx=Store())],
                            value=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Test when workcenter and MO are using the same analytic account, no\n        duplicated lines will be post.\n        ', kind=None),
                        ),
                        Assign(
                            targets=[
                                Attribute(
                        ...
                        With(
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Constant(value=120.0, kind=None),
                                    type_comment=None,
                                ),
                            ],
                            type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='wc_analytic_account', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='wc_analytic_account', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Assign(
                            ...
                            value=Name(id='wc_analytic_account', ctx=Load()),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[Name(id='mo_form', ctx=Store())],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Name(id='wc_analytic_account', ctx=Load()),
                                ],
                                keywords=[],
                            ),
                        ),
