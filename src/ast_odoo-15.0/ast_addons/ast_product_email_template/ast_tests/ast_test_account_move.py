        ...
        ClassDef(
            ...
            body=[
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='YOUR PRODUCT', kind=None),
                                            Call(
                                                func=Attribute(
                                                    value=Subscript(
                                                        value=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='James Bond', kind=None),
                                            Constant(value='james.bond@yopmail.com', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='id_max', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        If(
                            test=Name(id='id_max', ctx=Load()),
                            body=[
                                Assign(
                                    targets=[Name(id='id_max', ctx=Store())],
                                    value=Attribute(
                                        value=Subscript(
                                            value=Name(id='id_max', ctx=Load()),
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    Constant(value='Walter PPK', kind=None),
                        ...
                        Assign(
                            targets=[Name(id='message_sent', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        ...
                                        args=[Name(id='message_sent', ctx=Load())],
                                        keywords=[],
                                    ),
                                    Constant(value=1, kind=None),
                                    Constant(value='Should send 1 message for product', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Subscript(
                                            value=Name(id='message_sent', ctx=Load()),
                                            slice=Constant(value=0, kind=None),
                                            ctx=Load(),
                                        ),
                                        attr='email_from',
                                    ...
                                    Constant(value='Should have from email address', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='pub_user', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='test_public_user', kind=None),
                                            Constant(value='test_public_user', kind=None),
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Call(
                                                ...
                                                args=[Name(id='pub_user', ctx=Load())],
                                                keywords=[],
                                            ),
                                            attr='sudo',
                                            ctx=Load(),
