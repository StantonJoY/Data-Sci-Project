        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='crm.lost.reason', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Opp. Lost Reason', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    targets=[Name(id='leads_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Integer',
                        ...
                        args=[Constant(value='Leads Count', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_leads_count', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                                ...
                                args=[
                                    List(
                                        elts=[
                                            Tuple(
                                                elts=[
                                                    Constant(value='lost_reason', kind=None),
                                    ...
                                    List(
                                        elts=[Constant(value='lost_reason', kind=None)],
                                        ctx=Load(),
                                    ),
                                    List(
                                        elts=[Constant(value='lost_reason', kind=None)],
                                            ...
                                            elts=[
                                                Subscript(
                                                    value=Subscript(
                                                        ...
                                                        slice=Constant(value='lost_reason', kind=None),
                                                        ctx=Load(),
                                                    ),
                                                ...
                                                Subscript(
                                                    value=Name(id='data', ctx=Load()),
                                                    slice=Constant(value='lost_reason_count', kind=None),
                                                    ctx=Load(),
                                                ),
                                            ],
                                            ctx=Load(),
                        ...
                        For(
                            target=Name(id='reason', ctx=Store()),
