                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='adyen', kind=None)],
                                keywords=[
                                    keyword(
                                        arg='update_values',
                                        value=Dict(
                                            keys=[
                                                Constant(value='adyen_merchant_account', kind=None),
                                                Constant(value='adyen_api_key', kind=None),
                                                Constant(value='adyen_client_key', kind=None),
                                                Constant(value='adyen_hmac_key', kind=None),
                                            ...
                                            values=[
                                                ...
                                                Constant(value='dummy', kind=None),
                                                Constant(value='dummy', kind=None),
                                                Constant(value='https://this.is.an.url', kind=None),
                                                Constant(value='https://this.is.an.url', kind=None),
                                            ],
                                        ),
                                    ),
