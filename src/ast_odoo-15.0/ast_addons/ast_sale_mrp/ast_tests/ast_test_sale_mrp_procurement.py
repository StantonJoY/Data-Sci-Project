            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='warehouse0', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Assign(
                            ...
                            value=Constant(value='Mobile Products Sellable', kind=None),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[Name(id='product_category_allproductssellable0', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='pc', ctx=Load()),
                                    attr='save',
                        ...
                        Assign(
                            ...
                            value=Name(id='product_category_allproductssellable0', ctx=Load()),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[
                        ...
                        Assign(
                            ...
                            value=Constant(value='Slider Mobile', kind=None),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Attribute(
                                            value=Name(id='warehouse0', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='product_template_slidermobile0', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='product', ctx=Load()),
                                    attr='save',
                        ...
                        Assign(
                            targets=[
                                Attribute(
                                    value=Name(id='product_template_slidermobile0', ctx=Load()),
                                    attr='standard_price',
                                    ctx=Store(),
                                ),
                            ],
                            value=Constant(value=189, kind=None),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[Name(id='product_component', ctx=Store())],
                            value=Call(
                                func=Name(id='Form', ctx=Load()),
                                args=[
                                    Subscript(
                        ...
                        Assign(
                            targets=[
                                Attribute(
                                    value=Name(id='product_component', ctx=Load()),
                                    attr='name',
                                    ctx=Store(),
                                ),
                            ],
                            value=Constant(value='Battery', kind=None),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[Name(id='product_product_bettery', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='product_component', ctx=Load()),
                                    attr='save',
                                ...
                                With(
                                    ...
                                    body=[
                                        Assign(
                                            ...
                                            value=Name(id='product_product_bettery', ctx=Load()),
                                            type_comment=None,
                                        ),
                                        Assign(
                                            targets=[
                        ...
                        Assign(
                            targets=[Name(id='sale_order_so0', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='so_form', ctx=Load()),
                                    attr='save',
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='sale_order_so0', ctx=Load()),
                                    attr='action_confirm',
                                    ctx=Load(),
                                ),
                                args=[],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Name(id='mo', ctx=Load()),
                                    Constant(value='Manufacturing order has not been generated', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Constant(value='Arrow', kind=None),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[
                        ...
                        Assign(
                            ...
                            value=Constant(value='Raw Iron', kind=None),
                            type_comment=None,
                        ),
                        Assign(
                            targets=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='User should see the correct number of manufacture orders in smart button', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
