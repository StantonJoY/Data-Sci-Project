        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='report.l10n_fr_pos_cert.report_pos_hash_integrity', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Get french pos hash integrity result as PDF.', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
