        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='sale.product.configurator', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='product_configurator_template_attribute_value_rel', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='string',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='product_configurator_custom_attribute_value_rel', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='string',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            Constant(value='product.template.attribute.value', kind=None),
                            Constant(value='product_configurator_no_variant_attribute_value_rel', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='string',
