        ...
        ClassDef(
            ...
            body=[
                                                    ...
                                                    exc=Call(
                                                        ...
                                                        args=[
                                                            Call(
                                                                ...
                                                                args=[Constant(value='You do not have enough extra hours to request this leave', kind=None)],
                                                                keywords=[],
                                                            ),
                                                        ],
                                                        keywords=[],
                                        ...
                                        Raise(
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        func=Name(id='_', ctx=Load()),
                                                        args=[Constant(value='The employee does not have enough extra hours to request this leave.', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
                                                ...
                                                Raise(
                                                    exc=Call(
                                                        ...
                                                        args=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[Constant(value='The employee does not have enough extra hours to extend this leave.', kind=None)],
                                                                keywords=[],
                                                            ),
                                                        ],
                                                        keywords=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='overtime_leaves', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='filtered',
                                    ...
                                    ListComp(
                                        ...
                                        generators=[
                                            comprehension(
                                                ...
                                                iter=Name(id='overtime_leaves', ctx=Load()),
                                                ifs=[],
                                                is_async=0,
                                            ),
                                        ],
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                                            value=Attribute(
                                                value=Name(id='overtime_leaves', ctx=Load()),
                                                attr='overtime_id',
                                                ctx=Load(),
                                            ),
                                            attr='sudo',
