        ...
        ClassDef(
            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=" Invite channels don't give enroll if not member ", kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=" Public channels don't give enroll if not member ", kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Unpublished channels and their content are visible only to eLearning people ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    List(
                                        elts=[Constant(value='website_published', kind=None)],
                                        ctx=Load(),
                                    ),
                                ],
                                keywords=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Slides with preview flag are always visible even to non members if published ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestRemoveMembership', ctx=Load()),
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='id_slide_partner', ctx=Store())],
                            value=Attribute(
                                value=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='slide_partner',
                        ...
                        Assign(
                            targets=[Name(id='id_channel_partner', ctx=Store())],
                            value=Attribute(
                                value=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='channel_partner',
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            BinOp(
                                                                ...
                                                                op=Mod(),
                                                                right=Name(id='id_channel_partner', ctx=Load()),
                                                            ),
                                                        ],
                                                        ctx=Load(),
                                                    ),
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            BinOp(
                                                                left=Constant(value='%d', kind=None),
                                                                op=Mod(),
                                                                right=Name(id='id_slide_partner', ctx=Load()),
                                                            ),
                                                        ],
                                                        ctx=Load(),
                                                    ),
            ...
            decorator_list=[
                Call(
                    ...
                    args=[
                        ...
                        Constant(value='security', kind=None),
                    ],
                    keywords=[],
                ),
            ],
        ...
        ClassDef(
            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='user_employees', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Call(
                                        func=Attribute(
                                            value=Name(id='user_employees', ctx=Load()),
                                            attr='mapped',
                                            ctx=Load(),
                                        ),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='NewUser', kind=None),
                                            Constant(value='NewUser', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                        ...
                        Assign(
                            targets=[Name(id='new_user_2', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='NewUser2', kind=None),
                                            Constant(value='NewUser2', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='new_user_2', ctx=Load()),
                                    attr='write',
                                    ctx=Load(),
                                ),
                                args=[
                        ...
                        Assign(
                            targets=[Name(id='new_user_3', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='NewUser3', kind=None),
                                            Constant(value='NewUser3', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                ...
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                                            Constant(value=4, kind=None),
                                                            Attribute(
                                                                value=Name(id='new_user_3', ctx=Load()),
                                                                attr='id',
                                                                ctx=Load(),
                                                            ),
                                                        ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='channel_manager', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='channel_portal', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='channel_portal', ctx=Load()),
                                        attr='can_upload',
                                        ctx=Load(),
                                    ),
                                ],
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='channel_manager', ctx=Load()),
                                    attr='write',
                                    ctx=Load(),
                                ),
                                args=[
                                    Dict(
                                        keys=[Constant(value='upload_group_ids', kind=None)],
                                        values=[
                                            List(
                                                elts=[
                                                    Tuple(
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='channel_officer', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='channel_officer', ctx=Load()),
                                        attr='can_upload',
                                        ctx=Load(),
                                    ),
                                ],
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='channel_superuser', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='channel_superuser', ctx=Load()),
                                    attr='invalidate_cache',
                                    ctx=Load(),
                                ),
                                args=[
