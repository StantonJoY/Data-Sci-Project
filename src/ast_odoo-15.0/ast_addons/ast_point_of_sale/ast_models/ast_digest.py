    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='kpi_pos_total', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='POS Sales', kind=None)],
                        keywords=[],
                    ),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='kpi_pos_total_value', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Monetary',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_kpi_pos_total_value', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    name='_compute_kpi_pos_total_value',
                    args=arguments(
                        posonlyargs=[],
                        ...
                        Assign(
                            targets=[
                                Subscript(
                                    ...
                                    slice=Constant(value='kpi_pos_total', kind=None),
                                    ctx=Store(),
                                ),
                            ],
                            value=BinOp(
                                left=Constant(value='point_of_sale.action_pos_sale_graph&menu_id=%s', kind=None),
                                op=Mod(),
                                right=Attribute(
                                    value=Call(
                                        func=Attribute(
                                        ...
                                        args=[Constant(value='point_of_sale.menu_point_root', kind=None)],
                                        keywords=[],
                                    ),
                                    attr='id',
                                    ctx=Load(),
