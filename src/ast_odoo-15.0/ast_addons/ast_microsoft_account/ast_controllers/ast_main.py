        ...
        ClassDef(
            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' This route/function is called by Microsoft when user Accept/Refuse the consent of Microsoft ', kind=None),
                        ),
                        Assign(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='/microsoft_account/authentication', kind=None)],
                            keywords=[
                                keyword(
                                    arg='type',
