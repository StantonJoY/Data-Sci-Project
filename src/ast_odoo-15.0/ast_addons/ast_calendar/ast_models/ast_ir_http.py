                    ...
                    body=[
                        ...
                        If(
                            ...
                            body=[
                                Assign(
                                    targets=[Name(id='error_message', ctx=Store())],
                                    value=Constant(value='Invalid Invitation Token.', kind=None),
                                    type_comment=None,
                                ),
                            ],
                            orelse=[
                                    ...
                                    test=BoolOp(
                                        ...
                                        values=[
                                            ...
                                            Compare(
                                                ...
                                                ops=[NotEq()],
                                                comparators=[Constant(value='anonymous', kind=None)],
                                            ),
                                        ],
                                    ),
                                    body=[
                                        ...
                                        If(
                                            ...
                                            body=[
                                                Assign(
                                                    targets=[Name(id='error_message', ctx=Store())],
                                                    value=BinOp(
                                                        left=Constant(value='Invitation cannot be forwarded via email. This event/meeting belongs to %s and you are logged in as %s. Please ask organizer to add you.', kind=None),
                                                        op=Mod(),
                                                        right=Tuple(
                                                            elts=[
                                                                Attribute(
