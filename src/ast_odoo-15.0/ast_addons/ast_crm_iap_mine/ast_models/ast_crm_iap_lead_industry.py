Module(
    body=[
        ...
        ClassDef(
            ...
            body=[
                Expr(
                    value=Constant(value=' Industry Tags of Acquisition Rules ', kind=None),
                ),
                Assign(
                    targets=[Name(id='_name', ctx=Store())],
                    value=Constant(value='crm.iap.lead.industry', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value="The list of reveal_ids for this industry, separated with ','", kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                        ...
                        elts=[
                            Tuple(
                                elts=[
                                    ...
                                    Constant(value='Industry name already exists!', kind=None),
                                ],
                                ctx=Load(),
                            ),
                        ],
