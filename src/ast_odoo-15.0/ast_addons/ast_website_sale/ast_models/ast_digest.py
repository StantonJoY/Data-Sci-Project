    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='kpi_website_sale_total', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='eCommerce Sales', kind=None)],
                        keywords=[],
                    ),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='kpi_website_sale_total_value', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Monetary',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_kpi_website_sale_total_value', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                    ...
                    body=[
                        ...
                        For(
                            ...
                            body=[
                                ...
                                Assign(
                                    targets=[Name(id='confirmed_website_sales', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                                ...
                                Assign(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Attribute(
                                                    value=Name(id='confirmed_website_sales', ctx=Load()),
                                                    attr='mapped',
                                                    ctx=Load(),
                                                ),
                        ...
                        Assign(
                            targets=[
                                Subscript(
                                    ...
                                    slice=Constant(value='kpi_website_sale_total', kind=None),
                                    ctx=Store(),
                                ),
                            ],
                            value=BinOp(
                                left=Constant(value='website.backend_dashboard&menu_id=%s', kind=None),
                                op=Mod(),
                                right=Attribute(
                                    value=Call(
                                        func=Attribute(
