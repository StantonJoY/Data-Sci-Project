        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestReplenishWizard', ctx=Load()),
                                ...
                                args=[
                                    Call(
                                        ...
                                        keywords=[
                                            keyword(
                                                arg='name',
                                                value=Constant(value='The Replenisher', kind=None),
                                            ),
                                        ],
                                    ),
                                ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Set a quantity to replenish via the "Buy" route and check if\n        a purchase order is created with the correct values\n        ', kind=None),
                        ),
                        Assign(
                            targets=[
                                Attribute(
                        ...
                        Assign(
                            targets=[Name(id='replenish_wizard', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                        ...
                                        slice=Constant(value='product.replenish', kind=None),
                                        ctx=Load(),
                                    ),
                                    attr='create',
                                    ctx=Load(),
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='replenish_wizard', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='last_po_id', ctx=Store())],
                            value=Subscript(
                                value=Call(
                                    func=Attribute(
                                        value=Subscript(
                                            ...
                                            elts=[
                                                Tuple(
                                                    elts=[
                                                        ...
                                                        Constant(value='%Manual Replenishment%', kind=None),
                                                    ],
                                                    ctx=Load(),
                                                ),
                                                Tuple(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Name(id='last_po_id', ctx=Load()),
                                    Constant(value='Purchase Order not found', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Assign(
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='last_po_id', ctx=Load()),
                                        attr='order_line',
                                        ctx=Load(),
                                    ),
                                    attr='search',
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='The product is not in the Purchase Order', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Quantities does not match', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Prices does not match', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Choose supplier based on the ordered quantity and minimum price\n\n        replenish 10\n\n        1)seq1 vendor1 140 min qty 1\n        2)seq2 vendor1 100  min qty 10\n        -> 2) should be chosen\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='product_to_buy', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Furniture Service', kind=None),
                                            Constant(value='product', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='vendor1', kind=None),
                        ...
                        Assign(
                            targets=[Name(id='supplierinfo1', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Attribute(
                                                value=Attribute(
                                                    value=Name(id='product_to_buy', ctx=Load()),
                                                    attr='product_tmpl_id',
                                                    ctx=Load(),
                                                ),
                                                attr='id',
                        ...
                        Assign(
                            targets=[Name(id='supplierinfo2', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='vendor2', kind=None),
                        ...
                        Assign(
                            targets=[Name(id='supplierinfo3', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
