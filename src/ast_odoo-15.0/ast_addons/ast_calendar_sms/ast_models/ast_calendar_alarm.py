                                    ...
                                    elts=[
                                        Tuple(
                                            elts=[
                                                ...
                                                Constant(value='SMS Text Message', kind=None),
                                            ],
                                            ctx=Load(),
                                        ),
                                    ],
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                                    ...
                                    elts=[
                                        Tuple(
                                            elts=[
                                                ...
                                                List(
                                                    elts=[Constant(value='calendar.event', kind=None)],
                                                    ctx=Load(),
                                                ),
                                            ],
                                            ctx=Load(),
                            ...
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_sms_template_id', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Template used to render SMS reminder content.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                                    ...
                                    body=[
                                        Assign(
                                            ...
                                            value=Call(
                                                ...
                                                args=[Constant(value='calendar_sms.sms_template_data_calendar_reminder', kind=None)],
                                                keywords=[],
                                            ),
                                            type_comment=None,
                                        ),
