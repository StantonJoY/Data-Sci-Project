                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestWebsiteVisitor', ctx=Load()),
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='"Test Customer" <test@test.example.com>', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Attribute(
                    ...
                    body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[Constant(value='Mega Visitor', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Test Lead 1', kind=None),
                                            Constant(value='Rambeau Fort <beaufort@test.example.com', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Test Lead 1', kind=None),
                                            Constant(value='Martino Brie <brie@test.example.com', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='mobile', kind=None)],
                                        values=[Constant(value=False, kind=None)],
                                    ),
                                ],
                                keywords=[],
