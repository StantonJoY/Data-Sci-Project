            ...
            body=[
                ...
                FunctionDef(
                    ...
                    body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        ...
                                        args=[
                                            Constant(value='optional_product_ids', kind=None),
                                            List(elts=[], ctx=Load()),
                                        ],
                                        keywords=[],
                                    ),
                                ...
                                args=[
                                    Lambda(
                                        ...
                                        body=Compare(
                                            ...
                                            ops=[Eq()],
                                            comparators=[Name(id='linked_line_id', ctx=Load())],
                                        ),
                                    ),
                                ],
                                keywords=[],
                        ...
                        If(
                            test=Name(id='optional_product_ids', ctx=Load()),
                            body=[
                                Assign(
                                    targets=[Name(id='lines', ctx=Store())],
                                    value=Call(
                                        ...
                                        args=[
                                            Lambda(
                                                ...
                                                body=Compare(
                                                    left=Name(id='optional_product_ids', ctx=Load()),
                                                    ops=[Eq()],
                                                    comparators=[
                                                        Call(
                                                            func=Name(id='set', ctx=Load()),
                                                            args=[
                                                                Call(
                                                                    ...
                                                                    args=[Constant(value='option_line_ids.product_id.id', kind=None)],
                                                                    keywords=[],
                                                                ),
                                                            ],
                                                            keywords=[],
