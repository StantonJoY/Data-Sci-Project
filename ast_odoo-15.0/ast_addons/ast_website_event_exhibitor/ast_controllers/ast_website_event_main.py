                        ...
                        If(
                            ...
                            test=BoolOp(
                                ...
                                values=[
                                    Compare(
                                        ...
                                        end_lineno=15,
                                        end_col_offset=36,
                                        left=Constant(lineno=15, col_offset=11, end_lineno=15, end_col_offset=28, value='from_sponsor_id', kind=None),
                                        ops=[In()],
                                        comparators=[Name(lineno=15, col_offset=32, end_lineno=15, end_col_offset=36, id='post', ctx=Load())],
                                    ),
                                    UnaryOp(
                                        lineno=15,
                                        col_offset=41,
                                        ...
                                        operand=Attribute(
                                            ...
                                            end_lineno=15,
                                            end_col_offset=61,
                                            value=Name(lineno=15, col_offset=45, end_lineno=15, end_col_offset=50, id='event', ctx=Load()),
                                            attr='is_ongoing',
                                            ctx=Load(),
                                        ),
                                    ),
                            ...
                            body=[
                                Assign(
                                    ...
                                    end_lineno=16,
                                    end_col_offset=96,
                                    targets=[Name(lineno=16, col_offset=12, end_lineno=16, end_col_offset=19, id='sponsor', ctx=Store())],
                                    value=Call(
                                        lineno=16,
                                        col_offset=22,
                                        end_lineno=16,
                                            ...
                                            value=Call(
                                                ...
                                                func=Attribute(
                                                    ...
                                                    value=Subscript(
                                                        ...
                                                        value=Attribute(
                                                            ...
                                                            end_lineno=16,
                                                            end_col_offset=33,
                                                            value=Name(lineno=16, col_offset=22, end_lineno=16, end_col_offset=29, id='request', ctx=Load()),
                                                            attr='env',
                                                            ctx=Load(),
                                                        ),
                                                        slice=Constant(lineno=16, col_offset=34, end_lineno=16, end_col_offset=49, value='event.sponsor', kind=None),
                                                        ctx=Load(),
                                                    ),
                                                    attr='browse',
                                                    ctx=Load(),
                                                ...
                                                args=[
                                                    Call(
                                                        ...
                                                        end_lineno=16,
                                                        end_col_offset=86,
                                                        func=Name(lineno=16, col_offset=58, end_lineno=16, end_col_offset=61, id='int', ctx=Load()),
                                                        args=[
                                                            Subscript(
                                                                lineno=16,
                                                                col_offset=62,
                                                                end_lineno=16,
                                                                end_col_offset=85,
                                                                value=Name(lineno=16, col_offset=62, end_lineno=16, end_col_offset=66, id='post', ctx=Load()),
                                                                slice=Constant(lineno=16, col_offset=67, end_lineno=16, end_col_offset=84, value='from_sponsor_id', kind=None),
                                                                ctx=Load(),
                                                            ),
                                                        ],
                                                        keywords=[],
                                ...
                                If(
                                    ...
                                    end_lineno=23,
                                    end_col_offset=17,
                                    test=Name(lineno=17, col_offset=15, end_lineno=17, end_col_offset=22, id='sponsor', ctx=Load()),
                                    body=[
                                        Assign(
                                            lineno=18,
                                            col_offset=16,
                                        ...
                                        Assign(
                                            ...
                                            value=BinOp(
                                                ...
                                                left=Call(
                                                    ...
                                                    args=[Constant(lineno=21, col_offset=22, end_lineno=21, end_col_offset=84, value='The event %s starts on %s (%s). \nJoin us there to meet %s !', kind=None)],
                                                    keywords=[],
                                                ),
                                                op=Mod(),
                                                right=Tuple(
                                                    ...
                                                    elts=[
                                                        ...
                                                        Attribute(
                                                            ...
                                                            end_lineno=22,
                                                            end_col_offset=82,
                                                            value=Name(lineno=22, col_offset=62, end_lineno=22, end_col_offset=69, id='sponsor', ctx=Load()),
                                                            attr='partner_name',
                                                            ctx=Load(),
                                                        ),
                                                    ],
