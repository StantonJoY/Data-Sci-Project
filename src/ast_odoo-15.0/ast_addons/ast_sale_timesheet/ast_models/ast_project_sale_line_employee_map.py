        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='project.sale.line.employee.map', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Project Sales line, employee mapping', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='Sale Order Item', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='compute',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='project_id.partner_id', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_price_unit', kind=None),
                            ),
                            keyword(
                                arg='store',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='currency_field',
                                value=Constant(value='cost_currency_id', kind=None),
                            ),
                            keyword(
                                arg='compute',
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value="This cost overrides the employee's default timesheet cost in employee's HR Settings", kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Cost Currency', kind=None),
                            ),
                            keyword(
                                arg='related',
                                value=Constant(value='employee_id.currency_id', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    targets=[Name(id='is_cost_changed', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        args=[Constant(value='Is Cost Manually Changed', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_is_cost_changed', kind=None),
                            ),
                            keyword(
                                arg='store',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=List(
                        elts=[
                            Tuple(
                                elts=[
                                    Constant(value='uniqueness_employee', kind=None),
                                    Constant(value='UNIQUE(project_id,employee_id)', kind=None),
                ...
                FunctionDef(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='sale_line_id.price_unit', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                ...
                FunctionDef(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='employee_id.timesheet_cost', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='ProjectProductEmployeeMap', ctx=Load()),
