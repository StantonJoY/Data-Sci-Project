            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                                ...
                                args=[
                                    Dict(
                                        keys=[
                                            ...
                                            Constant(value='account_sale_tax_id', kind=None),
                                            Constant(value='account_purchase_tax_id', kind=None),
                                        ],
                                        values=[
                        ...
                        Assign(
                            targets=[Name(id='account_with_taxes', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='account_with_taxes', ctx=Load()),
                                    attr='write',
                                    ctx=Load(),
                                ),
                                args=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='account_tour', kind=None),
                                ],
                                keywords=[
                                    keyword(
                                        arg='login',
