        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='lunch.topping', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Lunch Extras', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='lunch.supplier', kind=None)],
                        keywords=[
                            keyword(
                                arg='ondelete',
                ...
                Assign(
                    targets=[Name(id='topping_category', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Integer',
                        ...
                        args=[Constant(value='Topping Category', kind=None)],
                        keywords=[
                            keyword(
                                arg='help',
                                value=Constant(value='This field is a technical field', kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
