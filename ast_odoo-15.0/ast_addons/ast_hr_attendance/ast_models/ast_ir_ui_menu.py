                    ...
                    body=[
                        ...
                        If(
                            ...
                            test=Call(
                                ...
                                args=[Constant(lineno=12, col_offset=35, end_lineno=12, end_col_offset=75, value='hr_attendance.group_hr_attendance_user', kind=None)],
                                keywords=[],
                            ),
                            body=[
                                Expr(
                                        ...
                                        args=[
                                            Attribute(
                                                ...
                                                value=Call(
                                                    ...
                                                    args=[Constant(lineno=13, col_offset=36, end_lineno=13, end_col_offset=91, value='hr_attendance.menu_hr_attendance_attendances_overview', kind=None)],
                                                    keywords=[],
                                                ),
                                                attr='id',
                                                ctx=Load(),
