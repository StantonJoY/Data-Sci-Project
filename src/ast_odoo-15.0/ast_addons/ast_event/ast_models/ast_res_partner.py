                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_event_count', kind=None),
                            ),
                            keyword(
                                arg='groups',
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Number of events the partner has participated.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                                        ...
                                        args=[
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                                            Constant(value='registration_ids.partner_id', kind=None),
                    ...
                    body=[
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='event.action_event_view', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
