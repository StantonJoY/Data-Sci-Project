                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Booth Count', kind=None),
                            ),
                            keyword(
                                arg='compute',
                ...
                FunctionDef(
                    ...
                    body=[
                        If(
                            ...
                            body=[
                                Assign(
                                    targets=[Name(id='slot_data', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                                ...
                                Assign(
                                    targets=[Name(id='slot_mapped', ctx=Store())],
                                    value=Call(
                                            ...
                                            GeneratorExp(
                                                ...
                                                generators=[
                                                    comprehension(
                                                        ...
                                                        iter=Name(id='slot_data', ctx=Load()),
                                                        ifs=[],
                                                        is_async=0,
                                                    ),
                                                ],
                        ...
                        For(
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='slot_mapped', ctx=Load()),
                                            attr='get',
                                            ctx=Load(),
                                        ),
                                        args=[
                    ...
                    body=[
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='event_booth.event_booth_action', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
