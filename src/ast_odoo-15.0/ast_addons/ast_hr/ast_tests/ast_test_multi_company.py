                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[Constant(value='Opoo', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='Otoo', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                                    ...
                                    List(
                                        elts=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Bidule', kind=None),
                                                    Attribute(
                                                        value=Attribute(
                                                            value=Name(id='self', ctx=Load()),
                                                            attr='company_1',
                                            ...
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Machin', kind=None),
                                                    Attribute(
                                                        value=Attribute(
                                                            value=Name(id='self', ctx=Load()),
                                                            attr='company_2',
                    ...
                    body=[
                                            ...
                                            value=Call(
                                                func=Attribute(
                                                    value=Call(
                                                        ...
                                                        args=[Constant(value='hr.hr_employee_print_badge', kind=None)],
                                                        keywords=[],
                                                    ),
                                                    attr='with_user',
                                                    ctx=Load(),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value=b'Bidule', kind=None),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value=b'Machin', kind=None),
                                    Name(id='content', ctx=Load()),
                                ],
                                keywords=[],
                            ),
