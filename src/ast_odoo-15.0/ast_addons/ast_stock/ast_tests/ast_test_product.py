        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestVirtualAvailable', ctx=Load()),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='a move', kind=None),
                                            Attribute(
                                                value=Attribute(
                                                    value=Name(id='self', ctx=Load()),
                                                    attr='product_3',
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='another move', kind=None),
                                            Attribute(
                                                value=Attribute(
                                                    value=Name(id='self', ctx=Load()),
                                                    attr='product_3',
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='prod_context', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value=10.0, kind=None),
                                    Attribute(
                                        value=Name(id='prod_context', ctx=Load()),
                                        attr='virtual_available',
                                        ctx=Load(),
                                    ),
                                ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Test the value of product.free_qty. Free_qty = qty_on_hand - qty_reserved', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='`qty_available` and `virtual_available` are computed on archived products', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Archiving a product should archive its reordering rules', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Brand new product', kind=None),
