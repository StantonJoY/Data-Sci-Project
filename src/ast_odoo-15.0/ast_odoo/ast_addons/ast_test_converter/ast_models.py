    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='Test Converter Model', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='test_converter.test_model.sub', kind=None)],
                        keywords=[
                            keyword(
                                arg='group_expand',
                                value=Constant(value='_gbf_m2o', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value="Qu'il n'est pas arrivé à Toronto", kind='u'),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value="Qu'il était supposé arriver à Toronto", kind='u'),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                    ...
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='La réponse D', kind='u'),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        args=[
                            ...
                            arg(arg='subs', annotation=None, type_comment=None),
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='sub_ids', ctx=Store())],
                            value=Call(
                                func=Attribute(
        ...
        ClassDef(
            ...
            body=[
                Assign(
                    targets=[Name(id='_name', ctx=Store())],
                    value=Constant(value='test_converter.test_model.sub', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Subtraction For Test Model & Test Converter', kind=None),
                    type_comment=None,
                ),
                Assign(
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Test Converter Monetary', kind=None),
                    type_comment=None,
                ),
                Assign(
