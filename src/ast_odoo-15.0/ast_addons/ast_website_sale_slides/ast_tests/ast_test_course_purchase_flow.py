        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='salesman', kind=None),
                                            Constant(value='salesman', kind=None),
                                            Constant(value='salesman007@example.com', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='course_product', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Course Product', kind=None),
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Attribute(
                                                value=Name(id='course_product', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                        ],
                        ...
                        Assign(
                            targets=[Name(id='salesman_sale_order', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='salesman_sale_order', ctx=Load()),
                                    attr='action_confirm',
                                    ctx=Load(),
                                ),
                                args=[],
