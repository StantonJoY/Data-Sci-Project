    ...
    body=[
                                            ...
                                            exc=Call(
                                                ...
                                                args=[
                                                    Call(
                                                        ...
                                                        args=[Constant(value='The selected employee does not correspond to the selected user.', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                                keywords=[],
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='granted_employees_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Integer',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_granted_employees_count', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='owner_ids.employee_id', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                        ...
                        Return(
                            value=Dict(
                                ...
                                values=[
                                    ...
                                    Constant(value='Granted Employees', kind=None),
