                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='crm_tour', kind=None),
                                ],
                                keywords=[
                                    keyword(
                                        arg='login',
                    ...
                    body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Temporary CRM User', kind=None),
                                            Constant(value='temp_crm_user', kind=None),
                                            Constant(value='temp_crm_user', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='/web', kind=None),
                                    Constant(value='crm_rainbowman', kind=None),
                                ],
                                keywords=[
                                    keyword(
                                        arg='login',
                                        value=Constant(value='temp_crm_user', kind=None),
                                    ),
                                ],
                            ),
                        ),
                    ...
                    body=[
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='/web', kind=None),
                                    Constant(value='crm_forecast', kind=None),
                                ],
                                keywords=[
                                    keyword(
                                        arg='login',
