        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='sms.cancel', kind=None),
                    type_comment=None,
                ),
                Assign(
                                ...
                                Assign(
                                    ...
                                    value=BinOp(
                                        left=Call(
                                            ...
                                            args=[Constant(value="Are you sure you want to discard %s SMS delivery failures? You won't be able to re-send these SMS later!", kind=None)],
                                            keywords=[],
                                        ),
                                        op=Mod(),
                                        right=Call(
                    ...
                    body=[
                        ...
                        For(
                            ...
                            body=[
                                ...
                                If(
                                    test=Name(id='message_ids', ctx=Load()),
                                    body=[
                                        Expr(
                                            value=Call(
                                                func=Attribute(
