            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestPurchaseRequisitionCommon', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='user_group_purchase_manager', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='user_group_purchase_user', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='cls', ctx=Load()),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Purchase requisition Manager', kind=None),
                                            Constant(value='prm', kind=None),
                                            Constant(value='requisition_manager@yourcompany.com', kind=None),
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            List(
                                                                elts=[
                                                                    Attribute(
                                                                        value=Name(id='user_group_purchase_manager', ctx=Load()),
                                                                        attr='id',
                                                                        ctx=Load(),
                                                                    ),
                                                                ],
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Purchase requisition User', kind=None),
                                            Constant(value='pru', kind=None),
                                            Constant(value='requisition_user@yourcompany.com', kind=None),
                                            Constant(value='inbox', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            List(
                                                                elts=[
                                                                    Attribute(
                                                                        value=Name(id='user_group_purchase_user', ctx=Load()),
                                                                        attr='id',
                                                                        ctx=Load(),
                                                                    ),
                                                                ],
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='E-COM10', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                                ...
                                args=[
                                    Dict(
                                        keys=[
                                            ...
                                            Constant(value='uom_po_id', kind=None),
                                            Constant(value='default_code', kind=None),
                                            Constant(value='purchase_requisition', kind=None),
                                        ],
                                        values=[
                                            Constant(value='Corner Desk Black', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Attribute(
                                            ...
                                            Constant(value='FURN_1118', kind=None),
