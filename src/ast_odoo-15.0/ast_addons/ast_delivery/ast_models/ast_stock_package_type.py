    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='shipper_package_code', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='Carrier Code', kind=None)],
                        keywords=[],
                    ),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='package_carrier_type', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Selection',
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='No carrier integration', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                ...
                FunctionDef(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='package_carrier_type', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
