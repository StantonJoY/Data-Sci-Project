Module(
    body=[
        ...
        Assign(
            targets=[Name(id='DEFAULT_MICROSOFT_AUTH_ENDPOINT', ctx=Store())],
            value=Constant(value='https://login.microsoftonline.com/common/oauth2/v2.0/authorize', kind=None),
            type_comment=None,
        ),
        Assign(
            targets=[Name(id='DEFAULT_MICROSOFT_TOKEN_ENDPOINT', ctx=Store())],
            value=Constant(value='https://login.microsoftonline.com/common/oauth2/v2.0/token', kind=None),
            type_comment=None,
        ),
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='microsoft.service', kind=None),
                    type_comment=None,
                ),
                Assign(
                    ...
                    body=[
                        Return(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='microsoft_account.auth_endpoint', kind=None),
                                    Name(id='DEFAULT_MICROSOFT_AUTH_ENDPOINT', ctx=Load()),
                                ],
                                keywords=[],
                            ),
                        ),
                    ...
                    body=[
                        Return(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='microsoft_account.token_endpoint', kind=None),
                                    Name(id='DEFAULT_MICROSOFT_TOKEN_ENDPOINT', ctx=Load()),
                                ],
                                keywords=[],
                            ),
                        ),
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    BinOp(
                                        left=Constant(value='microsoft_%s_client_id', kind=None),
                                        op=Mod(),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    BinOp(
                                        left=Constant(value='microsoft_%s_client_secret', kind=None),
                                        op=Mod(),
                                        right=Name(id='service', ctx=Load()),
                                    ),
                                ],
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='microsoft_redirect_uri', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                                ...
                                args=[
                                    Dict(
                                        keys=[
                                            ...
                                            Constant(value='scope', kind=None),
                                            Constant(value='redirect_uri', kind=None),
                                            Constant(value='prompt', kind=None),
                                        ...
                                        values=[
                                            ...
                                            BinOp(
                                                ...
                                                op=Add(),
                                                right=Constant(value='/microsoft_account/authentication', kind=None),
                                            ),
                                            Constant(value='consent', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Call Microsoft API to exchange authorization code against token, with POST request, to\n            not be redirected.\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='get_param', ctx=Store())],
                            value=Attribute(
                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        defaults=[
                            ...
                            Constant(value='https://graph.microsoft.com', kind=None),
                            Name(id='TIMEOUT', ctx=Load()),
                        ],
                    ),
                    body=[
                        Expr(
                            value=Constant(value=" Execute the request to Microsoft API. Return a tuple ('HTTP_CODE', 'HTTP_RESPONSE')\n            :param uri : the url to contact\n            :param params : dict or already encoded parameters for the request to make\n            :param headers : headers of request\n            :param method : the method to use to make the request\n            :param preuri : pre url to prepend to param uri.\n        ", kind=None),
                        ),
                        If(
                            test=Compare(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    BinOp(
                                        left=Constant(value='Uri: %s - Type : %s - Headers: %s - Params : %s !', kind=None),
                                        op=Mod(),
                                        right=Tuple(
                                            elts=[
                                                    ...
                                                    exc=Call(
                                                        ...
                                                        args=[
                                                            Call(
                                                                func=Name(id='_', ctx=Load()),
                                                                args=[
                                                                    Constant(value='Method not supported [%s] not in [GET, POST, PUT, PATCH or DELETE]!', kind=None),
                                                                    Name(id='method', ctx=Load()),
                                                                ],
                                                                keywords=[],
                                                            ),
                                            ...
                                            orelse=[
                                                Expr(
                                                    value=Call(
                                                        ...
                                                        args=[
                                                            Constant(value='Bad microsoft request : %s !', kind=None),
                                                            Attribute(
                                                                value=Attribute(
                                                                    value=Name(id='error', ctx=Load()),
                                                                    attr='response',
