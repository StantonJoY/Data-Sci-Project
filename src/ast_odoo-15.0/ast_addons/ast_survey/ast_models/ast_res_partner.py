    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='certifications_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='Certifications Count', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_certifications_count', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='certifications_company_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Integer',
                        ...
                        args=[Constant(value='Company Certifications Count', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_certifications_company_count', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[
                                ...
                                Constant(value='child_ids.certifications_count', kind=None),
                            ],
                            keywords=[],
                        ),
                    ],
                    ...
                    body=[
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='survey.res_partner_action_certifications', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
