        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        ...
                                        slice=Constant(value='crm.iap.lead.mining.request', kind=None),
                                        ctx=Load(),
                                    ),
                                    attr='create',
                                    ctx=Load(),
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='Test Mine', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='mine_request', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        With(
                            items=[
                                withitem(
                                    context_expr=Call(
                                        ...
                                        args=[Name(id='mine_request', ctx=Load())],
                                        keywords=[
                                            keyword(
                                                arg='sim_error',
                            ...
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='mine_request', ctx=Load()),
                                            attr='action_submit',
                                            ctx=Load(),
                                        ),
                                        args=[],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value=3, kind=None),
                                    Constant(value='Number of leads should match mine request', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        For(
                            target=Name(id='base_name', ctx=Store()),
                            iter=List(
                                elts=[
                                    Constant(value='Heinrich', kind=None),
                                    Constant(value='Rivil', kind=None),
                    ...
                    body=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='search_type', kind=None)],
                                        values=[Constant(value='companies', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
