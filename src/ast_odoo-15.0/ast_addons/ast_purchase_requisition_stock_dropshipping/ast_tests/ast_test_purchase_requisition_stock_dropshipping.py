                    ...
                    body=[
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[Constant(value='prsds-product', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='purchase_requisition', kind=None)],
                                        values=[Constant(value='tenders', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='prsds-customer', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Assign(
                            targets=[Name(id='call_for_tender', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[Name(id='call_for_tender', ctx=Load())],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='call_for_tender', ctx=Load()),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='prsds-vendor', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Purchase order should be linked with call for tender', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Purchase order should be delivered at customer', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Purchase order should be linked with sale order', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Purchase order line should be linked with sale order line', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
