        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='/payment/buckaroo/return', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                    name='buckaroo_return_from_redirect',
                    args=arguments(
                        posonlyargs=[],
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Process the data returned by Buckaroo after redirection.\n\n        :param dict data: The feedback data\n        ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                                ...
                                args=[
                                    Constant(value='received notification data:\n%s', kind=None),
                                    Call(
                                        func=Attribute(
