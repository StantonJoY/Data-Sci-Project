Module(
    body=[
        ...
        ClassDef(
            ...
            body=[
                Expr(
                    value=Constant(value='Templates for sending SMS', kind=None),
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Constant(value='SMS Templates', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Applies to', kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                            ...
                            keyword(
                                ...
                                value=List(
                                    elts=[
                                        ...
                                        Tuple(
                                            elts=[
                                                Constant(value='is_mail_thread_sms', kind=None),
                                                Constant(value='=', kind=None),
                ...
                Assign(
                    targets=[Name(id='sidebar_action_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[Constant(value='sidebar_action_id', kind=None)],
                                        keywords=[],
                                    ),
                                    attr='unlink',
                                    ctx=Load(),
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='sms.sms_composer_view_form', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Call(
                                        func=Name(id='_', ctx=Load()),
                                        args=[
                                            Constant(value='Send SMS (%s)', kind=None),
                                            Attribute(
                                                value=Name(id='template', ctx=Load()),
                                                attr='name',
                                                ctx=Load(),
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    ...
                                                    BinOp(
                                                        left=Constant(value="{'default_template_id' : %d, 'sms_composition_mode': 'guess', 'default_res_ids': active_ids, 'default_res_id': active_id}", kind=None),
                                                        op=Mod(),
                                                        right=Attribute(
                                                            value=Name(id='template', ctx=Load()),
                                                            attr='id',
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='sidebar_action_id', kind=None)],
                                                values=[
                                                    Attribute(
