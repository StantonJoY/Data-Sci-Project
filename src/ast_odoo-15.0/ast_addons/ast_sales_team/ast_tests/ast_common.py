Module(
    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                keywords=[
                                    keyword(
                                        arg='login',
                                        value=Constant(value='user_sales_salesman', kind=None),
                                    ),
                                    keyword(
                                        arg='name',
                                        value=Constant(value='Orteil Sales Own', kind=None),
                                    ),
                                    keyword(
                                        arg='email',
                                        value=Constant(value='crm_salesman@test.example.com', kind=None),
                                    ),
                                    keyword(
                                        arg='company_id',
                                        value=Attribute(
        ...
        ClassDef(
            ...
            body=[
                Expr(
                    value=Constant(value=' Multi Company / Multi Sales Team environment ', kind=None),
                ),
                FunctionDef(
                    name='setUpClass',
                    args=arguments(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Teams / Company\n\n          * sales_team_1: False\n          * team_c2: company_2\n          * team_mc: company_main\n        ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
