                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        args=[
                            ...
                            arg(arg='date_planned', annotation=None, type_comment=None),
                        ],
                        vararg=None,
                        kwonlyargs=[],
                        kw_defaults=[],
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='order_values', ctx=Store())],
                            value=Dict(
                                keys=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='PurchaseTestCommon', ctx=Load()),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='T-shirt', kind=None),
                                            Constant(value='Internal Notes', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='pu', kind=None),
                                            Constant(value='purchaseuser@yourcompany.com', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
