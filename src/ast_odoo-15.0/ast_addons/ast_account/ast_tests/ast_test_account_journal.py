        ...
        ClassDef(
            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' The accounts linked to a bank/cash journal must share the same foreign currency\n        if specified.\n        ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='journal_bank', ctx=Store())],
                            value=Subscript(
                                value=Attribute(
                        ...
                        Assign(
                            targets=[
                                Attribute(
                                    value=Name(id='journal_bank', ctx=Load()),
                                    attr='currency_id',
                                    ctx=Store(),
                                ),
                            ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=" Ensure you can't change the company of an account.journal if there are some journal entries ", kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Multi method', kind=None),
                                                    Constant(value='multi', kind=None),
                                        ...
                                        args=[
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                                            Constant(value='inbound_payment_method_line_ids.code', kind=None),
                                                            Constant(value='=', kind=None),
                                                            Constant(value='multi', kind=None),
                                                        ],
                                                        ctx=Load(),
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Call(
                                                ...
                                                args=[Name(id='journals', ctx=Load())],
                                                keywords=[],
                                            ),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='first_method', ctx=Store())],
                            value=Attribute(
                                value=Name(id='self', ctx=Load()),
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Attribute(
                                                value=Name(id='first_method', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                        ],
                        ...
                        Assign(
                            targets=[Name(id='second_method', ctx=Store())],
                            value=Attribute(
                                value=Name(id='self', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='second_method', ctx=Load()),
                                    attr='unlink',
                                    ctx=Load(),
                                ),
                                args=[],
