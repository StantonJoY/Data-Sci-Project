    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='attendee_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        args=[Constant(value='Attendee Count', kind=None)],
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_attendee_count', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Synchronize partner from SO to registrations. This is done notably\n        in website_sale controller shop/address that updates customer, but not\n        only. ', kind=None),
                        ),
                        Assign(
                        ...
                        If(
                            ...
                            body=[
                                Assign(
                                    targets=[Name(id='registrations_toupdate', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                                ...
                                Expr(
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='registrations_toupdate', ctx=Load()),
                                            attr='write',
                                            ctx=Load(),
                                        ),
                                        args=[
                                    ...
                                    body=[
                                        Return(
                                            value=Call(
                                                ...
                                                args=[Constant(value='event_sale.action_sale_order_event_registration', kind=None)],
                                                keywords=[],
                                            ),
                                        ),
                                    ],
                    ...
                    body=[
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='event.event_registration_action_tree', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='sale_orders_data', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='attendee_count_data', ctx=Store())],
                            value=DictComp(
                                key=Subscript(
                                    value=Subscript(
                                        value=Name(id='sale_order_data', ctx=Load()),
                                ...
                                generators=[
                                    comprehension(
                                        target=Name(id='sale_order_data', ctx=Store()),
                                        iter=Name(id='sale_orders_data', ctx=Load()),
                                        ifs=[],
                                        is_async=0,
                                    ),
                                ],
                        ...
                        For(
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='attendee_count_data', ctx=Load()),
                                            attr='get',
                                            ctx=Load(),
                                        ),
                                        args=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Choose an event and it will automatically create a registration for this event.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Choose an event ticket and it will automatically create a registration for this event ticket.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='event_ok', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_event_ok', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='product_id.detailed_type', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='event_lines', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='filtered',
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='event_lines', ctx=Load()),
                                    attr='update',
                                    ctx=Load(),
                                ),
                                args=[
                                    Dict(
                                        keys=[Constant(value='product_uom_readonly', kind=None)],
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            ...
                                            BinOp(
                                                ...
                                                op=Sub(),
                                                right=Name(id='event_lines', ctx=Load()),
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        args=[
                            arg(arg='self', annotation=None, type_comment=None),
                            arg(arg='confirm', annotation=None, type_comment=None),
                            arg(arg='cancel_to_draft', annotation=None, type_comment=None),
                            arg(arg='registration_data', annotation=None, type_comment=None),
                            arg(arg='mark_as_paid', annotation=None, type_comment=None),
                        ],
                        vararg=None,
                        kwonlyargs=[],
                        kw_defaults=[],
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Create or update registrations linked to a sales order line. A sale\n        order line has a product_uom_qty attribute that will be the number of\n        registrations linked to this line. This method update existing registrations\n        and create new one for missing one. ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='RegistrationSudo', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Assign(
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Name(id='RegistrationSudo', ctx=Load()),
                                    attr='search',
                                    ctx=Load(),
                                ),
                                args=[
                        ...
                        Assign(
                            targets=[Name(id='registrations_vals', ctx=Store())],
                        ...
                        For(
                            ...
                            iter=Call(
                                ...
                                args=[Constant(value='event_ok', kind=None)],
                                keywords=[],
                            ),
                            body=[
                                Assign(
                                        ...
                                        Expr(
                                            value=Call(
                                                func=Attribute(
                                                    value=Call(
                                                        func=Attribute(
                                                            value=Name(id='existing_registrations', ctx=Load()),
                                                            attr='filtered',
                                                            ctx=Load(),
                                                        ),
                                                        args=[
                                ...
                                If(
                                    test=Name(id='mark_as_paid', ctx=Load()),
                                    body=[
                                        Expr(
                                            value=Call(
                                                func=Attribute(
                                ...
                                If(
                                    test=Name(id='cancel_to_draft', ctx=Load()),
                                    body=[
                                        Expr(
                                            value=Call(
                                                func=Attribute(
                                ...
                                For(
                                    ...
                                    body=[
                                        ...
                                        If(
                                            test=Name(id='registration_data', ctx=Load()),
                                            body=[
                                                Expr(
                                                    value=Call(
                                                        func=Attribute(
                                                        ...
                                                        args=[
                                                            Call(
                                                                func=Attribute(
                                                                    value=Name(id='registration_data', ctx=Load()),
                                                                    attr='pop',
                                                                    ctx=Load(),
                                                                ),
                                                                args=[],
                                        ...
                                        Expr(
                                            value=Call(
                                                func=Attribute(
                                                    value=Name(id='registrations_vals', ctx=Load()),
                                                    attr='append',
                                                    ctx=Load(),
                                                ),
                        ...
                        If(
                            test=Name(id='registrations_vals', ctx=Load()),
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
                                        ...
                                        args=[Name(id='registrations_vals', ctx=Load())],
                                        keywords=[],
                                    ),
                                ),
                            ],
                                            ...
                                            Compare(
                                                ...
                                                comparators=[
                                                    Call(
                                                        ...
                                                        args=[Constant(value='event_ticket_ids.product_id.id', kind=None)],
                                                        keywords=[],
                                                    ),
                                                ],
                                            ),
