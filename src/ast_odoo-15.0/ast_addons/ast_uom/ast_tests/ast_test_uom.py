        ...
        ClassDef(
            ...
            body=[
                    ...
                    body=[
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Constant(value=1020000, kind=None),
                                    Attribute(
                                        value=Name(id='self', ctx=Load()),
                                        attr='uom_ton',
                                        ctx=Load(),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value=1.02, kind=None),
                                    Constant(value='Converted quantity does not correspond.', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value=2000000.0, kind=None),
                                    Constant(value='Converted price does not correspond.', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Name(id='qty', ctx=Load()),
                                    Constant(value=1, kind=None),
                                    Constant(value='Converted quantity should be rounded up.', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Check the uniqueness of the reference UoM in a category ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='time_category', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Second Time Reference', kind=None),
                                                    Constant(value=1, kind=None),
                                                    Constant(value='reference', kind=None),
                                                    Constant(value=1.0, kind=None),
                                                    Attribute(
                                                        value=Name(id='time_category', ctx=Load()),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ),
                                                ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' A custom UoM is an UoM in a category without measurement type. It should behave like a normal UoM ', kind=None),
                        ),
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[Constant(value='Custom UoM category', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    Constant(value='Bigger UoM of my category', kind=None),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Reference UoM of my category', kind=None),
                                            Constant(value=1, kind=None),
                                            Constant(value='reference', kind=None),
                                            Constant(value=1.0, kind=None),
                                            Attribute(
