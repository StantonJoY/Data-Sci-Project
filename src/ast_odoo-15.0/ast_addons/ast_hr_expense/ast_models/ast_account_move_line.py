    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='expense_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Expense where the move line come from', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='not_paid_expenses', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='not_paid_expense_sheets', ctx=Store())],
                            value=Attribute(
                                value=Name(id='not_paid_expenses', ctx=Load()),
                                attr='sheet_id',
                                ctx=Load(),
                            ),
                            type_comment=None,
                        ...
                        Assign(
                            targets=[Name(id='paid_expenses', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='not_paid_expenses', ctx=Load()),
                                    attr='filtered',
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='paid_expenses', ctx=Load()),
                                    attr='write',
                                    ctx=Load(),
                                ),
                                args=[
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='not_paid_expense_sheets', ctx=Load()),
                                            attr='filtered',
                                            ctx=Load(),
                                        ),
                                        args=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='attachment_domains', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Name(id='super', ctx=Load()),
                        ...
                        If(
                            ...
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
                                            value=Name(id='attachment_domains', ctx=Load()),
                                            attr='append',
                                            ctx=Load(),
                                        ),
                                        args=[
