            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestMrpMulticompany', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='group_mrp_manager', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='self', ctx=Load()),
                                ...
                                args=[Constant(value='mrp.group_mrp_manager', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                                                        ...
                                                        elts=[
                                                            ...
                                                            List(
                                                                elts=[
                                                                    ...
                                                                    Attribute(
                                                                        value=Name(id='group_mrp_manager', ctx=Load()),
                                                                        attr='id',
                                                                        ctx=Load(),
                                                                    ),
                                                                ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Check it is not possible to use a product of Company B in a\n        bom of Company A. ', kind=None),
                        ),
                        Assign(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Check it is not possible to use a product of Company B as a component\n        in a bom of Company A. ', kind=None),
                        ),
                        Assign(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Check it is not possible to confirm a production of Company B with\n        product of Company A. ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='product_a', ctx=Store())],
                            value=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Check that confirming a production in company b with user_a will create\n        stock moves on company b. ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='product_a', ctx=Store())],
                            value=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Check that using a finished lot of company b in the produce wizard of a production\n        of company a is not allowed ', kind=None),
                        ),
                        Assign(
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='p2', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Check that using a component lot of company b in the produce wizard of a production\n        of company a is not allowed ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='product', ctx=Store())],
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='p1', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' On a product without company, as a user of Company B, check it is not possible to use a\n        location limited to Company A as `property_stock_production` ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='shared_product', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                Assign(
                                    targets=[
                                        Attribute(
                                            value=Call(
                                                func=Attribute(
                                                    value=Name(id='shared_product', ctx=Load()),
                                                    attr='with_user',
                                                    ctx=Load(),
                                                ),
                                                args=[
