            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='wish_id', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='Wishlist', ctx=Load()),
                                ...
                                Assign(
                                    targets=[
                                        Subscript(
                                            ...
                                            slice=Constant(value='wishlist_ids', kind=None),
                                            ctx=Store(),
                                        ),
                                    ],
                                    value=BinOp(
                                        ...
                                        right=List(
                                            elts=[
                                                Attribute(
                                                    value=Name(id='wish_id', ctx=Load()),
                                                    attr='id',
                                                    ctx=Load(),
                                                ),
                                            ],
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[
                                List(
                                    elts=[Constant(value='/shop/wishlist/add', kind=None)],
                                    ctx=Load(),
                                ),
                            ],
                            keywords=[
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Return(
                            value=Call(
                                ...
                                args=[
                                    Constant(value='website_sale_wishlist.product_wishlist', kind=None),
                                    Call(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[
                                List(
                                    elts=[Constant(value='/shop/wishlist', kind=None)],
                                    ctx=Load(),
                                ),
                            ],
                            keywords=[
                ...
                FunctionDef(
                    ...
                    body=[
                        If(
                            ...
                            body=[
                                Assign(
                                    targets=[Name(id='wish_ids', ctx=Store())],
                                    value=BoolOp(
                                        op=Or(),
                                        values=[
                                            Call(
                                ...
                                If(
                                    test=Compare(
                                        ...
                                        ops=[In()],
                                        comparators=[Name(id='wish_ids', ctx=Load())],
                                    ),
                                    body=[
                                        Expr(
                                            value=Call(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[
                                List(
                                    elts=[Constant(value='/shop/wishlist/remove/<model("product.wishlist"):wish>', kind=None)],
                                    ctx=Load(),
                                ),
                            ],
                            keywords=[
