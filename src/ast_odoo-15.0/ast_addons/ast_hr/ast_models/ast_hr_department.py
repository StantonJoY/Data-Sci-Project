            ...
            body=[
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='Department Name', kind=None)],
                        keywords=[
                            keyword(
                                arg='required',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Parent Department', kind=None),
                            ),
                            keyword(
                                arg='index',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Child Departments', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='total_employee', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Integer',
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_total_employee', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='Total Employee', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='jobs_ids', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='One2many',
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Jobs', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='emp_data', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                    ...
                                    GeneratorExp(
                                        ...
                                        generators=[
                                            comprehension(
                                                ...
                                                iter=Name(id='emp_data', ctx=Load()),
                                                ifs=[],
                                                is_async=0,
                                            ),
                                        ],
                                    ...
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                ...
                                                args=[Constant(value='You cannot create recursive departments.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
                            ...
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        ...
                                        args=[Constant(value='manager_id', kind=None)],
                                        keywords=[],
                                    ),
                                ],
                                keywords=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' If updating manager of a department, we need to update all the employees\n            of department hierarchy, and subscribe the new manager.\n        ', kind=None),
                        ),
                        If(
                            test=Compare(
                                left=Constant(value='manager_id', kind=None),
                                ops=[In()],
                            ...
                            body=[
                                ...
                                If(
                                    test=Name(id='manager_id', ctx=Load()),
                                    body=[
                                        Assign(
                                            targets=[Name(id='manager', ctx=Store())],
                                            value=Call(
                                                ...
                                                args=[Name(id='manager_id', ctx=Load())],
                                                keywords=[],
                                            ),
                                            type_comment=None,
                                        ),
                ...
                FunctionDef(
                    ...
                    args=arguments(
                        ...
                        args=[
                            arg(arg='self', annotation=None, type_comment=None),
                            arg(arg='manager_id', annotation=None, type_comment=None),
                        ],
                        vararg=None,
                        kwonlyargs=[],
                        kw_defaults=[],
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[Name(id='manager_id', ctx=Load())],
                                    ),
                                ],
                                keywords=[],
                            ),
