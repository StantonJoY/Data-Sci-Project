    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='sale_order_line_registration_ids', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2many',
                        ...
                        args=[
                            ...
                            Constant(value='event_booth_registration', kind=None),
                            Constant(value='event_booth_id', kind=None),
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='SO Lines with reservations', kind=None),
                            ),
                            keyword(
                                arg='groups',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Final Sale Order Line', kind=None),
                            ),
                            keyword(
                                arg='ondelete',
                            ...
                            keyword(
                                arg='states',
                                value=Dict(
                                    keys=[Constant(value='available', kind=None)],
                                    values=[
                                        List(
                                            elts=[
                                                Tuple(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='sale_order_line_id.order_id', kind=None),
                            ),
                            keyword(
                                arg='store',
                                value=Constant(value='True', kind=None),
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            targets=[Name(id='booth_with_so', ctx=Store())],
                            value=Call(
                                func=Attribute(
                        ...
                        If(
                            test=Name(id='booth_with_so', ctx=Load()),
                            body=[
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                ...
                                                args=[Constant(value="You can't delete the following booths as they are linked to sales orders: %(booths)s", kind=None)],
                                                keywords=[
                                                    keyword(
                                                        arg='booths',
                                                        value=Call(
                                                            ...
                                                            args=[
                                                                Call(
                                                                    func=Attribute(
                                                                        value=Name(id='booth_with_so', ctx=Load()),
                                                                        attr='mapped',
                                                                        ctx=Load(),
                                                                    ),
