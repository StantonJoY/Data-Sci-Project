Module(
    body=[
        ...
        FunctionDef(
            ...
            args=arguments(
                posonlyargs=[],
                args=[arg(arg='acc_number', annotation=None, type_comment=None)],
                vararg=None,
                kwonlyargs=[],
                kw_defaults=[],
                kwarg=None,
            ...
            body=[
                If(
                    test=Name(id='acc_number', ctx=Load()),
                    body=[
                        Return(
                            value=Call(
                                func=Attribute(
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='res.bank', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='Fed. State', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='domain',
                                value=Constant(value="[('country_id', '=?', country)]", kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='Bank Identifier Code', kind=None)],
                        keywords=[
                            keyword(
                                arg='index',
                                value=Constant(value=True, kind=None),
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Sometimes called BIC or Swift.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='acc_number', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Bank Accounts', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_order', ctx=Store())],
                                    ...
                                    Tuple(
                                        elts=[
                                            ...
                                            Call(
                                                ...
                                                args=[Constant(value='Normal', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        ctx=Load(),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_acc_type', kind=None),
                            ),
                            keyword(
                                arg='string',
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Bank account type: Normal or IBAN. Inferred from the bank account number.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='compute',
                                value=Constant(value='_compute_sanitized_acc_number', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='Sanitized Account Number', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    targets=[Name(id='acc_holder_name', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Char',
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Account Holder Name', kind=None),
                            ),
                            keyword(
                                arg='help',
                                value=Constant(value='Account holder name, in case it is different than the name of the Account Holder', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[
                            ...
                            Constant(value='Account Holder', kind=None),
                        ],
                        keywords=[
                            keyword(
                                arg='ondelete',
                ...
                Assign(
                    targets=[Name(id='bank_name', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Char',
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='bank_id.name', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                                value=Constant(value=False, kind=None),
                        ...
                        elts=[
                            Tuple(
                                elts=[
                                    ...
                                    Constant(value='unique(sanitized_acc_number, company_id)', kind=None),
                                    Constant(value='Account Number must be unique', kind=None),
                                ],
                                ctx=Load(),
                            ),
                        ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' To be overridden by subclasses in order to support other account_types.\n        ', kind=None),
                        ),
                        Return(
                            value=Constant(value='bank', kind=None),
                        ),
                            ...
                            body=[
                                If(
                                    test=Compare(
                                        ...
                                        ops=[Eq()],
                                        comparators=[Constant(value='acc_number', kind=None)],
                                    ),
                                    body=[
                                        Assign(
                                        ...
                                        If(
                                            test=Compare(
                                                left=Constant(value='like', kind=None),
                                                ops=[In()],
                                                comparators=[Name(id='op', ctx=Load())],
                                            ),
                                            body=[
                                                Assign(
                                                    targets=[Name(id='value', ctx=Store())],
