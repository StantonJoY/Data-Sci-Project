Module(
    body=[
        ...
        ClassDef(
            name='PayumoneyTest',
            bases=[Name(id='PayumoneyCommon', ctx=Load())],
            keywords=[],
            body=[
                FunctionDef(
                        ...
                        Assign(
                            ...
                            value=Dict(
                                keys=[
                                    ...
                                    Constant(value='surl', kind=None),
                                    Constant(value='furl', kind=None),
                                    Constant(value='service_provider', kind=None),
                                ],
                                values=[
                                    Attribute(
                                        value=Attribute(
                                    ...
                                    Name(id='return_url', ctx=Load()),
                                    Constant(value='payu_paisa', kind=None),
                                ],
                            ),
                            type_comment=None,
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='https://sandboxsecure.payu.in/_payment', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='PayUMoney: invalid inputs specified in the redirect form.', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
