        ...
        ClassDef(
            ...
            body=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' If Saudi Arabia chart, we add 3 new journals Tax Adjustments, IFRS 16 and Zakat', kind=None),
                        ),
                        If(
                            test=Compare(
                                ...
                                comparators=[
                                    Call(
                                        ...
                                        args=[Constant(value='l10n_sa.sa_chart_template_standard', kind=None)],
                                        keywords=[],
                                    ),
                                ],
                            ),
                                            ...
                                            List(
                                                elts=[
                                                    ...
                                                    Dict(
                                                        ...
                                                        values=[
                                                            Constant(value='IFRS 16 Right of Use Asset', kind=None),
                                                            Attribute(
                                                                value=Name(id='company', ctx=Load()),
                                                                attr='id',
                                                                ctx=Load(),
                                                    ...
                                                    Dict(
                                                        ...
                                                        values=[
                                                            Constant(value='Zakat', kind=None),
                                                            Attribute(
                                                                value=Name(id='company', ctx=Load()),
                                                                attr='id',
                                                                ctx=Load(),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        If(
                            ...
                            body=[
                                Assign(
                                    targets=[Name(id='ifrs_journal_id', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                                ...
                                If(
                                    test=Name(id='ifrs_journal_id', ctx=Load()),
                                    body=[
                                        Assign(
                                                ...
                                                elts=[
                                                    Attribute(
                                                        value=Call(
                                                            ...
                                                            args=[Constant(value='l10n_sa.sa_account_100101', kind=None)],
                                                            keywords=[],
                                                        ),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ...
                                                    Attribute(
                                                        value=Call(
                                                            ...
                                                            args=[Constant(value='l10n_sa.sa_account_100102', kind=None)],
                                                            keywords=[],
                                                        ),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ...
                                                    Attribute(
                                                        value=Call(
                                                            ...
                                                            args=[Constant(value='l10n_sa.sa_account_400070', kind=None)],
                                                            keywords=[],
                                                        ),
                                                        attr='id',
                                                        ctx=Load(),
                                                        ...
                                                        elts=[
                                                            Tuple(
                                                                elts=[
                                                                    ...
                                                                    Attribute(
                                                                        value=Name(id='ifrs_journal_id', ctx=Load()),
                                                                        attr='id',
                                                                        ctx=Load(),
                                                                    ),
                                ...
                                Assign(
                                    targets=[Name(id='zakat_journal_id', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                value=Attribute(
                                ...
                                If(
                                    test=Name(id='zakat_journal_id', ctx=Load()),
                                    body=[
                                        Assign(
                                            targets=[Name(id='zakat_account_ids', ctx=Store())],
                                            value=List(
                                                elts=[
                                                    Attribute(
                                                        value=Call(
                                                            ...
                                                            args=[Constant(value='l10n_sa.sa_account_201019', kind=None)],
                                                            keywords=[],
                                                        ),
                                                        attr='id',
                                                        ctx=Load(),
                                                    ...
                                                    Attribute(
                                                        value=Call(
                                                            ...
                                                            args=[Constant(value='l10n_sa.sa_account_400072', kind=None)],
                                                            keywords=[],
                                                        ),
                                                        attr='id',
                                                        ctx=Load(),
                                        ...
                                        Assign(
                                            targets=[Name(id='zakat_accounts', ctx=Store())],
                                            value=Call(
                                                func=Attribute(
                                                    value=Subscript(
                                                        value=Attribute(
                                                ...
                                                args=[
                                                    ListComp(
                                                        ...
                                                        generators=[
                                                            comprehension(
                                                                target=Name(id='id', ctx=Store()),
                                                                iter=Name(id='zakat_account_ids', ctx=Load()),
                                                                ifs=[],
                                                                is_async=0,
                                                            ),
                                                        ],
                                        ...
                                        For(
                                            target=Name(id='account', ctx=Store()),
                                            iter=Name(id='zakat_accounts', ctx=Load()),
                                            body=[
                                                Assign(
                                                    targets=[
                                                        Attribute(
                                                        ...
                                                        elts=[
                                                            Tuple(
                                                                elts=[
                                                                    Constant(value=4, kind=None),
                                                                    Attribute(
                                                                        value=Name(id='zakat_journal_id', ctx=Load()),
                                                                        attr='id',
                                                                        ctx=Load(),
                                                                    ),
                                                                    Constant(value=0, kind=None),
