Module(
    body=[
        ...
        ClassDef(
            ...
            bases=[Name(lineno=5, col_offset=22, end_lineno=5, end_col_offset=35, id='PaymentCommon', ctx=Load())],
            keywords=[],
            body=[
                FunctionDef(
                    lineno=8,
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                func=Attribute(
                                    ...
                                    end_lineno=11,
                                    end_col_offset=45,
                                    value=Name(lineno=11, col_offset=24, end_lineno=11, end_col_offset=27, id='cls', ctx=Load()),
                                    attr='_prepare_acquirer',
                                    ctx=Load(),
                                ),
                                args=[Constant(lineno=11, col_offset=46, end_lineno=11, end_col_offset=57, value='payumoney', kind=None)],
                                keywords=[
                                    keyword(
                                        lineno=11,
                                        col_offset=59,
                                        ...
                                        value=Dict(
                                            ...
                                            end_col_offset=9,
                                            keys=[
                                                Constant(lineno=12, col_offset=12, end_lineno=12, end_col_offset=36, value='payumoney_merchant_key', kind=None),
                                                Constant(lineno=13, col_offset=12, end_lineno=13, end_col_offset=37, value='payumoney_merchant_salt', kind=None),
                                            ],
                                            values=[
                                                Constant(lineno=12, col_offset=38, end_lineno=12, end_col_offset=45, value='dummy', kind=None),
                                                Constant(lineno=13, col_offset=39, end_lineno=13, end_col_offset=46, value='dummy', kind=None),
                                            ],
                                        ),
                                    ),
                                ],
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(lineno=18, col_offset=45, end_lineno=18, end_col_offset=50, value='INR', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
