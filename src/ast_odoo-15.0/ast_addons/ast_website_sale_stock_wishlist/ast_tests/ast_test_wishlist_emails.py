Module(
    body=[
        ...
        ClassDef(
            ...
            bases=[Name(id='TestWebsiteSaleStockProductWarehouse', ctx=Load())],
            keywords=[],
            body=[
                FunctionDef(
                    name='setUpClass',
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='john@doe.com', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Wishlist Warehouse', kind=None),
                                            Constant(value='W_WH', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='Wishlist', ctx=Store())],
                            value=Subscript(
                                value=Attribute(
                                    value=Name(id='self', ctx=Load()),
                                    attr='env',
                        ...
                        Assign(
                            targets=[Name(id='wish_1', ctx=Store())],
                            value=Call(
                                func=Attribute(
                        ...
                        Assign(
                            targets=[Name(id='wish_2', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='Wishlist', ctx=Load()),
                                    attr='_add_to_wishlist',
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value="The product 'Product B' is now available", kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
