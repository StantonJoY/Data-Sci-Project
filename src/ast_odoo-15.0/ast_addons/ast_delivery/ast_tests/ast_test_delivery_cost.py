                    ...
                    body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestDeliveryCost', ctx=Load()),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='Another Customer', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value="Another Customer's Address", kind=None),
                                            Attribute(
                                                value=Attribute(
                                                    value=Name(id='self', ctx=Load()),
                                                    attr='partner_4',
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(value='account.account_tag_operating', kind=None)],
                                keywords=[],
                            ),
                            type_comment=None,
                        ),
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='name', kind=None)],
                                        values=[Constant(value='Zizizaproduct', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    Constant(value='PC Assamble + 2GB RAM', kind=None),
                                                                    Attribute(
                                                                        value=Attribute(
                                                                            value=Name(id='self', ctx=Load()),
                                                                            attr='product_4',
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value=1, kind=None),
                                    Constant(value='Delivery cost is not Added', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Assign(
                            targets=[Name(id='zin', ctx=Store())],
                            value=BinOp(
                                left=BinOp(
                                    left=BinOp(
                                        left=BinOp(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value=0, kind=None),
                                    BinOp(
                                        left=Constant(value='Delivery cost does not correspond to 10.0. %s %s', kind=None),
                                        op=Mod(),
                                        right=Tuple(
                                            elts=[
                                                Attribute(
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    Constant(value='Service on demand', kind=None),
                                                                    Attribute(
                                                                        value=Attribute(
                                                                            value=Name(id='self', ctx=Load()),
                                                                            attr='product_consultant',
                                                    ...
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    Constant(value='On Site Assistance', kind=None),
                                                                    Attribute(
                                                                        value=Attribute(
                                                                            value=Name(id='self', ctx=Load()),
                                                                            attr='product_2',
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value=0, kind=None),
                                    Constant(value='Delivery cost is not correspond.', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
