        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='event.type.booth', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Event Booth Template', kind=None),
                    type_comment=None,
                ),
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Assign booth category by default if only one exists', kind=None),
                        ),
                        Assign(
                        ...
                        If(
                            ...
                            body=[
                                Return(
                                    value=Name(id='category_id', ctx=Load()),
                                ),
                            ],
                            orelse=[],
                        ),
                ...
                Assign(
                    targets=[Name(id='booth_category_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='default',
                                value=Name(id='_get_default_booth_category', ctx=Load()),
                            ),
                            keyword(
                                arg='ondelete',
