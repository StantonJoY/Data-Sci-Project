        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestLeadConvertToTicket', ctx=Load()),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Test partner creation while converting ', kind=None),
                        ),
                        Assign(
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                ...
                                                slice=Constant(value='crm.quotation.partner', kind=None),
                                                ctx=Load(),
                                            ),
                                            attr='with_context',
                                            ctx=Load(),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Subscript(
                                        ...
                                        slice=Constant(value='default_partner_id', kind=None),
                                        ctx=Load(),
                                    ),
                                    Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Test taking only existing customer while converting ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='lead', ctx=Store())],
                            value=Call(
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        keys=[Constant(value='action', kind=None)],
                                        values=[Constant(value='create', kind=None)],
                                    ),
                                ],
                                keywords=[],
                            ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Test doing nothing about customer while converting ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='lead', ctx=Store())],
                            value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[
                                                    Constant(value='active_model', kind=None),
                                                    Constant(value='active_id', kind=None),
                                                    Constant(value='default_action', kind=None),
                                                ],
                                                values=[
                                                    Constant(value='crm.lead', kind=None),
                                                    Attribute(
