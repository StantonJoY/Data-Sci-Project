        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='Stock Request an Inventory Count', kind=None),
                    type_comment=None,
                ),
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='Inventory Date', kind=None)],
                        keywords=[
                            keyword(
                                arg='required',
                ...
                Assign(
                    targets=[Name(id='set_count', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Selection',
                                ...
                                elts=[
                                    ...
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='Set Current Value', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                        ...
                        keywords=[
                            keyword(
                                arg='default',
                                value=Constant(value='empty', kind=None),
                            ),
                            keyword(
                                arg='string',
                ...
                FunctionDef(
                    ...
                    body=[
                        For(
                            target=Name(id='count_request', ctx=Store()),
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Call(
                                                func=Attribute(
                                                    value=Attribute(
                                                        value=Name(id='count_request', ctx=Load()),
                                                        attr='quant_ids',
                                                        ctx=Load(),
                                                    ),
                                                    attr='with_context',
                ...
                FunctionDef(
                    ...
                    body=[
                        Assign(
                            ...
                            value=Dict(
                                keys=[Constant(value='inventory_date', kind=None)],
                                values=[
                                    Attribute(
