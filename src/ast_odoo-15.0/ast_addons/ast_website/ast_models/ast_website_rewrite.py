    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='path', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_name', ctx=Store())],
                    value=Constant(value='website.route', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='All Website Route', kind=None),
                    type_comment=None,
                ),
                Assign(
                    ...
                    body=[
                        Expr(
                            value=Call(
                                ...
                                args=[Constant(value='Refreshing website.route', kind=None)],
                                keywords=[],
                            ),
                        ),
                        Assign(
                        ...
                        Assign(
                            targets=[Name(id='tocreate', ctx=Store())],
                                        ...
                                        If(
                                            ...
                                            orelse=[
                                                Expr(
                                                    value=Call(
                                                        func=Attribute(
                                                            value=Name(id='tocreate', ctx=Load()),
                                                            attr='append',
                                                            ctx=Load(),
                                                        ),
                                                        args=[
                                                            Dict(
                                                                keys=[Constant(value='path', kind=None)],
                        ...
                        If(
                            test=Name(id='tocreate', ctx=Load()),
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
                                        ...
                                        args=[
                                            BinOp(
                                                left=Constant(value='Add %d website.route', kind=None),
                                                op=Mod(),
                                                right=Call(
                                                    func=Name(id='len', ctx=Load()),
                                                    args=[Name(id='tocreate', ctx=Load())],
                                                    keywords=[],
                                                ),
                                            ),
                                        ],
                            ...
                            body=[
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            BinOp(
                                                left=Constant(value='Delete %d website.route', kind=None),
                                                op=Mod(),
                                                right=Call(
                                                    func=Name(id='len', ctx=Load()),
                                                    args=[Name(id='find', ctx=Load())],
                                                    keywords=[],
                                                ),
                                            ),
                                        ],
        ...
        ClassDef(
            ...
            body=[
                Assign(
                    targets=[Name(id='_name', ctx=Store())],
                    value=Constant(value='website.rewrite', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                ...
                Assign(
                    targets=[Name(id='url_from', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Char',
                        ...
                        args=[Constant(value='URL from', kind=None)],
                        keywords=[
                            keyword(
                                arg='index',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='website.route', kind=None)],
                        keywords=[],
                    ),
                    type_comment=None,
                ),
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='URL to', kind=None)],
                        keywords=[],
                    ),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='redirect_type', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Selection',
                                ...
                                elts=[
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='404 Not Found', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='301 Moved permanently', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='302 Moved temporarily', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                    Tuple(
                                        elts=[
                                            ...
                                            Constant(value='308 Redirect / Rewrite', kind=None),
                                        ],
                                        ctx=Load(),
                                    ),
                                ],
                ...
                FunctionDef(
                    ...
                    body=[
                        For(
                            target=Name(id='rewrite', ctx=Store()),
                                                    ...
                                                    exc=Call(
                                                        ...
                                                        args=[
                                                            Call(
                                                                ...
                                                                args=[Constant(value='"URL to" can not be empty.', kind=None)],
                                                                keywords=[],
                                                            ),
                                                        ],
                                                        keywords=[],
                                                        ...
                                                        Raise(
                                                            exc=Call(
                                                                ...
                                                                args=[
                                                                    Call(
                                                                        func=Name(id='_', ctx=Load()),
                                                                        args=[Constant(value='"URL to" must start with a leading slash.', kind=None)],
                                                                        keywords=[],
                                                                    ),
                                                                ],
                                                                keywords=[],
                                                            ...
                                                            exc=Call(
                                                                ...
                                                                args=[
                                                                    BinOp(
                                                                        left=Call(
                                                                            func=Name(id='_', ctx=Load()),
                                                                            args=[Constant(value='"URL to" must contain parameter %s used in "URL from".', kind=None)],
                                                                            keywords=[],
                                                                        ),
                                                                        op=Mod(),
                                                            ...
                                                            exc=Call(
                                                                ...
                                                                args=[
                                                                    BinOp(
                                                                        left=Call(
                                                                            func=Name(id='_', ctx=Load()),
                                                                            args=[Constant(value='"URL to" cannot contain parameter %s which is not used in "URL from".', kind=None)],
                                                                            keywords=[],
                                                                        ),
                                                                        op=Mod(),
                                                                        right=Name(id='param', ctx=Load()),
                                                            ...
                                                            exc=Call(
                                                                ...
                                                                args=[
                                                                    BinOp(
                                                                        left=Call(
                                                                            func=Name(id='_', ctx=Load()),
                                                                            args=[Constant(value='"URL to" is invalid: %s', kind=None)],
                                                                            keywords=[],
                                                                        ),
                                                                        op=Mod(),
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Name(id='super', ctx=Load()),
                                        args=[
                                            Name(id='WebsiteRewrite', ctx=Load()),
                                            Name(id='self', ctx=Load()),
                                        ],
                                        keywords=[],
                                    ),
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        ...
                                        slice=Constant(value='website.route', kind=None),
                                        ctx=Load(),
                                    ),
                                    attr='_refresh',
                                    ctx=Load(),
