Module(
    body=[
        ...
        ClassDef(
            ...
            body=[
                Expr(
                    value=Constant(value=' TODO ', kind=None),
                ),
                FunctionDef(
                    name='setUpClass',
                    args=arguments(
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestPhoneBlacklist', ctx=Load()),
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Subscript(
                                                ...
                                                slice=Constant(value='mail.test.sms.bl', kind=None),
                                                ctx=Load(),
                                            ),
                                            attr='with_context',
                                            ctx=Load(),
                    ...
                    body=[
                        With(
                            ...
                            body=[
                                ...
                                Assign(
                                    targets=[Name(id='bl_record', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Call(
                                                func=Attribute(
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Attribute(
                                                value=Name(id='bl_record', ctx=Load()),
                                                attr='active',
                                                ctx=Load(),
                                            ),
                                        ],
                                ...
                                Assign(
                                    targets=[Name(id='bl_record_2', ctx=Store())],
                                    value=Call(
                                        func=Attribute(
                                            value=Call(
                                                func=Attribute(
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='bl_record', ctx=Load()),
                                            Name(id='bl_record_2', ctx=Load()),
                                        ],
                                        keywords=[],
                                    ),
                                ),
                            ...
                            body=[
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='phone_nbr', kind=None)],
                                                values=[Constant(value='incorrect', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                                ...
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='mobile_nbr', kind=None)],
                                                values=[Constant(value='incorrect', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
