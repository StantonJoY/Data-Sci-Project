        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='accounting.assert.test', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Test Description', kind=None),
                            ),
                            keyword(
                                arg='index',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    targets=[Name(id='code_exec', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Text',
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='default',
                                value=Name(id='CODE_EXEC_DEFAULT', ctx=Load()),
                            ),
                        ],
                    ),
                    type_comment=None,
