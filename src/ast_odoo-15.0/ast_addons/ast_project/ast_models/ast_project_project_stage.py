        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='project.project.stage', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Project Stage', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='If set, an email will be sent to the customer when the project reaches this step.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='help',
                                value=Constant(value='This stage is folded in the kanban view.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
