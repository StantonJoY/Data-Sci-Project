        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestEventSale', ctx=Load()),
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                keywords=[
                                    keyword(
                                        arg='login',
                                        value=Constant(value='user_salesman', kind=None),
                                    ),
                                    keyword(
                                        arg='groups',
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Constant(value='Invoice after delivery', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Attribute(
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        ...
                                        slice=Constant(value='registration.editor', kind=None),
                                        ctx=Load(),
                                    ),
                                    attr='create',
                                    ctx=Load(),
                                                        ...
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    ...
                                                                    Constant(value='Administrator', kind=None),
                                                                    Constant(value='abc@example.com', kind=None),
                                                                    Attribute(
                                                                        value=Attribute(
                                                                            value=Attribute(
                                                                                value=Name(id='cls', ctx=Load()),
                    ...
                    body=[
                        Assign(
                            targets=[
                                Tuple(
                                    elts=[
                                        Name(id='TICKET1_COUNT', ctx=Store()),
                                        Name(id='TICKET2_COUNT', ctx=Store()),
                                    ],
                                    ctx=Store(),
                                ),
                            ],
                                                        ...
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    ...
                                                                    Name(id='TICKET1_COUNT', ctx=Load()),
                                                        ...
                                                        elts=[
                                                            ...
                                                            Dict(
                                                                ...
                                                                values=[
                                                                    ...
                                                                    Name(id='TICKET2_COUNT', ctx=Load()),
                        ...
                        Assign(
                            targets=[Name(id='ticket1_line', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='customer_so', ctx=Load()),
                                ...
                                args=[
                                    Lambda(
                                        ...
                                        body=Compare(
                                            ...
                                            ops=[Eq()],
                                            comparators=[Name(id='ticket1', ctx=Load())],
                                        ),
                                    ),
                                ],
                                keywords=[],
                        ...
                        Assign(
                            targets=[Name(id='ticket2_line', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='customer_so', ctx=Load()),
                                ...
                                args=[
                                    Lambda(
                                        ...
                                        body=Compare(
                                            ...
                                            ops=[Eq()],
                                            comparators=[Name(id='ticket2', ctx=Load())],
                                        ),
                                    ),
                                ],
                                keywords=[],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    BinOp(
                                        left=BinOp(
                                            left=Name(id='TICKET1_COUNT', ctx=Load()),
                                            op=Mult(),
                                            right=Constant(value=10, kind=None),
                                        ),
                                        op=Add(),
                                        right=BinOp(
                                            left=Name(id='TICKET2_COUNT', ctx=Load()),
                                            op=Mult(),
                        ...
                        Assign(
                            targets=[Name(id='ticket1_reg1', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Attribute(
                                                value=Name(id='ticket1_line', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                        ],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='ticket1_reg1', ctx=Load()),
                                        attr='partner_id',
                                        ctx=Load(),
                                    ),
                                    Attribute(
                        ...
                        Assign(
                            targets=[Name(id='editor', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                                        ...
                                        args=[
                                            Dict(
                                                keys=[Constant(value='default_sale_order_id', kind=None)],
                                                values=[
                                                    Attribute(
                                                        value=Name(id='customer_so', ctx=Load()),
                                                        attr='id',
                            ...
                            value=Call(
                                ...
                                args=[
                                    ...
                                    BinOp(
                                        left=Name(id='TICKET1_COUNT', ctx=Load()),
                                        op=Add(),
                                        right=Name(id='TICKET2_COUNT', ctx=Load()),
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    BinOp(
                                        left=Name(id='ticket1_line', ctx=Load()),
                                        op=BitOr(),
                                        right=Name(id='ticket2_line', ctx=Load()),
                                    ),
                                ],
                                keywords=[],
                            ),
                        ...
                        Assign(
                            targets=[Name(id='ticket1_editor_reg1', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='editor', ctx=Load()),
                            ...
                            body=[
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Subscript(
                                                value=Name(id='ticket1_editor_reg1', ctx=Load()),
                                                slice=Name(id='field', ctx=Load()),
                                                ctx=Load(),
                                            ),
                                            Subscript(
                        ...
                        Assign(
                            targets=[Name(id='ticket1_editor_other', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='editor', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        func=Name(id='len', ctx=Load()),
                                        args=[Name(id='ticket1_editor_other', ctx=Load())],
                                        keywords=[],
                                    ),
                        ...
                        Assign(
                            targets=[Name(id='ticket2_editor_other', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                                        value=Name(id='editor', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        func=Name(id='len', ctx=Load()),
                                        args=[Name(id='ticket2_editor_other', ctx=Load())],
                                        keywords=[],
                                    ),
                                    Constant(value=1, kind=None),
                                ],
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Name(id='ticket1_editor_other', ctx=Load()),
                                        slice=Constant(value=0, kind=None),
                                        ctx=Load(),
                                    ),
                                    attr='write',
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='ManualEntry1', kind=None),
                                            Constant(value='manual.email.1@test.example.com', kind=None),
                                            Constant(value='+32456111111', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='ManualEntry2', kind=None),
                                            Constant(value='manual.email.2@test.example.com', kind=None),
                                            Constant(value='+32456222222', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                        ...
                        Assign(
                            ...
                            value=BinOp(
                                ...
                                op=Sub(),
                                right=Name(id='ticket1_reg1', ctx=Load()),
                            ),
                            type_comment=None,
                        ),
                        Expr(
                        ...
                        Assign(
                            targets=[Name(id='ticket1_new_reg', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='new_registrations', ctx=Load()),
                                    attr='filtered',
                        ...
                        Assign(
                            targets=[Name(id='ticket2_new_reg', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='new_registrations', ctx=Load()),
                                    attr='filtered',
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        func=Name(id='len', ctx=Load()),
                                        args=[Name(id='ticket1_new_reg', ctx=Load())],
                                        keywords=[],
                                    ),
                                    Constant(value=2, kind=None),
                                ],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Call(
                                        func=Name(id='len', ctx=Load()),
                                        args=[Name(id='ticket2_new_reg', ctx=Load())],
                                        keywords=[],
                                    ),
                                    Constant(value=1, kind=None),
                                ],
                                ...
                                args=[
                                    Call(
                                        ...
                                        args=[
                                            Call(
                                                func=Attribute(
                                                    value=Name(id='ticket1_new_reg', ctx=Load()),
                                                    attr='mapped',
                                                    ctx=Load(),
                                                ),
                            ...
                            body=[
                                Expr(
                                    value=Call(
                                        ...
                                        args=[
                                            Subscript(
                                                value=Name(id='ticket2_new_reg', ctx=Load()),
                                                slice=Name(id='field', ctx=Load()),
                                                ctx=Load(),
                                            ),
                                            Subscript(
                        ...
                        Expr(
                            value=Call(
                                func=Attribute(
                                    value=Name(id='ticket2_line', ctx=Load()),
                                    attr='write',
                                    ctx=Load(),
                                ),
                                args=[
                        ...
                        Assign(
                            targets=[Name(id='editor_action', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Name(id='customer_so', ctx=Load()),
                                    attr='action_confirm',
                        ...
                        Assign(
                            ...
                            value=BinOp(
                                ...
                                right=BinOp(
                                    left=BinOp(
                                        left=Name(id='ticket1_reg1', ctx=Load()),
                                        op=BitOr(),
                                        right=Name(id='ticket1_new_reg', ctx=Load()),
                                    ),
                                    op=BitOr(),
                                    right=Name(id='ticket2_new_reg', ctx=Load()),
                                ),
                            ),
                            type_comment=None,
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Subscript(
                                        value=Name(id='editor_action', ctx=Load()),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='registration.editor', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='event_product', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Event Product', kind=None),
                        ...
                        Assign(
                            targets=[
                                Attribute(
                                    value=Name(id='event_product', ctx=Load()),
                                    attr='taxes_id',
                                    ctx=Store(),
                                ),
                            ],
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='New Event', kind=None),
                                            Constant(value='2020-02-02', kind=None),
                                            Constant(value='2020-04-04', kind=None),
                                        ],
                                    ),
                                ],
                                keywords=[],
                        ...
                        Assign(
                            targets=[Name(id='event_ticket', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Attribute(
                                                value=Name(id='event_ticket', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                        ],
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value=660.0, kind=None),
                                    Constant(value='Ticket is $1000 but the event product is on a pricelist 10 -> 6. So, $600 + a 10% tax.', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' This test ensures that when deleting a sale order, if the latter is linked to an event registration,\n        the number of expected seats will be correctly updated ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='event', ctx=Store())],
                            value=Call(
                    ...
                    decorator_list=[
                        Call(
                            func=Name(id='users', ctx=Load()),
                            args=[Constant(value='user_salesman', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' This test ensures that when deleting a sale order line, if the latter is linked to an event registration,\n        the number of expected seats will be correctly updated ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='event', ctx=Store())],
                            value=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' This test ensures that when canceling a sale order, if the latter is linked to an event registration,\n        the number of expected seats will be correctly updated ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='event', ctx=Store())],
                            value=Call(
            ...
            decorator_list=[
                Call(
                    ...
                    args=[Constant(value='event_flow', kind=None)],
                    keywords=[],
                ),
            ],
        ),
