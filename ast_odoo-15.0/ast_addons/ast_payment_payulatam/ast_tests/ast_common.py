                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                args=[Constant(lineno=12, col_offset=46, end_lineno=12, end_col_offset=57, value='payulatam', kind=None)],
                                keywords=[
                                    keyword(
                                        lineno=12,
                                        col_offset=59,
                                        ...
                                        value=Dict(
                                            ...
                                            end_col_offset=9,
                                            keys=[
                                                Constant(lineno=13, col_offset=12, end_lineno=13, end_col_offset=34, value='payulatam_account_id', kind=None),
                                                Constant(lineno=14, col_offset=12, end_lineno=14, end_col_offset=35, value='payulatam_merchant_id', kind=None),
                                                Constant(lineno=15, col_offset=12, end_lineno=15, end_col_offset=31, value='payulatam_api_key', kind=None),
                                            ],
                                            values=[
                                                Constant(lineno=13, col_offset=36, end_lineno=13, end_col_offset=43, value='dummy', kind=None),
                                                Constant(lineno=14, col_offset=37, end_lineno=14, end_col_offset=44, value='dummy', kind=None),
                                                Constant(lineno=15, col_offset=33, end_lineno=15, end_col_offset=40, value='dummy', kind=None),
                                            ],
                                        ),
                                    ),
                                ],
