Module(
    body=[
        ...
        ClassDef(
            ...
            body=[
                Expr(
                    value=Constant(value='Models a group member that can be either an email address either a full partner.', kind=None),
                ),
                Assign(
                    targets=[Name(id='_name', ctx=Store())],
                    value=Constant(value='mail.group.member', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Mailing List Member', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=List(
                        elts=[
                            Tuple(
                                elts=[
                                    Constant(value='unique_partner', kind=None),
                                    Constant(value='UNIQUE(partner_id, mail_group_id)', kind=None),
                                    Constant(value='This partner is already subscribed to the group', kind=None),
                                ],
                                ctx=Load(),
                            ),
                        ],
                ...
                FunctionDef(
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='partner_id.email', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
