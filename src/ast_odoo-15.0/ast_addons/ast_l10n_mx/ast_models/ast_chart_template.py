        ...
        ClassDef(
            ...
            body=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Set the tax_cash_basis_journal_id on the company', kind=None),
                        ),
                        Assign(
                                ...
                                operand=Compare(
                                    ...
                                    comparators=[
                                        Call(
                                            ...
                                            args=[Constant(value='l10n_mx.mx_coa', kind=None)],
                                            keywords=[],
                                        ),
                                    ],
                                ),
                        ...
                        Assign(
                            targets=[Name(id='journal_basis', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Attribute(
                                                value=Name(id='journal_basis', ctx=Load()),
                                                attr='id',
                                                ctx=Load(),
                                            ),
                                        ],
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value='Create the tax_cash_basis_journal_id', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='res', ctx=Store())],
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Call(
                                            ...
                                            args=[Constant(value='l10n_mx.cuenta118_01', kind=None)],
                                            keywords=[],
                                        ),
                                        attr='id',
                                        ctx=Load(),
                                    ...
                                    Dict(
                                        ...
                                        values=[
                                            ...
                                            Call(
                                                ...
                                                args=[Constant(value='Effectively Paid', kind=None)],
                                                keywords=[],
                                            ),
                                            Constant(value='CBMX', kind=None),
                                            Attribute(
                                ...
                                Assign(
                                    ...
                                    value=Attribute(
                                        value=Call(
                                            ...
                                            args=[Constant(value='l10n_mx.account_tag_102_01', kind=None)],
                                            keywords=[],
                                        ),
                                        attr='id',
                                        ctx=Load(),
