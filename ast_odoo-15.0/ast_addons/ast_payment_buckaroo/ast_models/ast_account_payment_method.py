                        ...
                        Assign(
                            ...
                            targets=[
                                Subscript(
                                    ...
                                    slice=Constant(lineno=13, col_offset=12, end_lineno=13, end_col_offset=22, value='buckaroo', kind=None),
                                    ctx=Store(),
                                ),
                            ],
                            value=Dict(
                                ...
                                end_col_offset=79,
                                keys=[
                                    Constant(lineno=13, col_offset=27, end_lineno=13, end_col_offset=33, value='mode', kind=None),
                                    Constant(lineno=13, col_offset=45, end_lineno=13, end_col_offset=53, value='domain', kind=None),
                                ],
                                values=[
                                    Constant(lineno=13, col_offset=35, end_lineno=13, end_col_offset=43, value='unique', kind=None),
                                    List(
                                        lineno=13,
                                        col_offset=55,
                                        end_lineno=13,
                                        ...
                                        elts=[
                                            Tuple(
                                                ...
                                                elts=[
                                                    ...
                                                    Constant(lineno=13, col_offset=65, end_lineno=13, end_col_offset=68, value='=', kind=None),
                                                    Constant(lineno=13, col_offset=70, end_lineno=13, end_col_offset=76, value='bank', kind=None),
                                                ],
                                                ctx=Load(),
                                            ),
                                        ],
