        ...
        ClassDef(
            ...
            body=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Override of payment to simulate a payment request.\n\n        Note: self.ensure_one()\n\n        :return: None\n        ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Override of payment to find the transaction based on dummy data.\n\n        :param str provider: The provider of the acquirer that handled the transaction\n        :param dict data: The dummy feedback data\n        :return: The transaction if found\n        :rtype: recordset of `payment.transaction`\n        :raise: ValidationError if the data match no transaction\n        ', kind=None),
                        ),
                        Assign(
                            ...
                            body=[
                                Raise(
                                    exc=Call(
                                        ...
                                        args=[
                                            BinOp(
                                                left=Constant(value='Test: ', kind=None),
                                                op=Add(),
                                                right=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Override of payment to process the transaction based on dummy data.\n\n        Note: self.ensure_one()\n\n        :param dict data: The dummy feedback data\n        :return: None\n        :raise: ValidationError if inconsistent data were received\n        ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    ...
                                                    Call(
                                                        ...
                                                        keywords=[
                                                            keyword(
                                                                ...
                                                                value=Subscript(
                                                                    value=Name(id='data', ctx=Load()),
                                                                    slice=Constant(value='cc_summary', kind=None),
                                                                    ctx=Load(),
                                                                ),
                                                            ),
                                                        ],
                                                    ...
                                                    Constant(value='fake acquirer reference', kind=None),
