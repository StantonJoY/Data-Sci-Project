        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='print.prenumbered.checks', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Print Pre-numbered Checks', kind=None),
                    type_comment=None,
                ),
                Assign(
                    ...
                    value=Call(
                        ...
                        args=[Constant(value='Next Check Number', kind=None)],
                        keywords=[
                            keyword(
                                arg='required',
                ...
                FunctionDef(
                    ...
                    body=[
                        For(
                            target=Name(id='check', ctx=Store()),
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='next_check_number', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                            ...
                            value=Call(
                                ...
                                args=[
                                    Subscript(
                                        ...
                                        slice=Constant(value='payment_ids', kind=None),
                                        ctx=Load(),
                                    ),
                                ],
                                keywords=[],
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=BinOp(
                                        ...
                                        op=Mod(),
                                        right=Name(id='check_number', ctx=Load()),
                                    ),
                                    type_comment=None,
                                ),
                                AugAssign(
                                    target=Name(id='check_number', ctx=Store()),
                                    op=Add(),
