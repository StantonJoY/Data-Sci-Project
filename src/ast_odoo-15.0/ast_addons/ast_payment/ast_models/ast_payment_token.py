        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    ...
                    value=Constant(value='partner_id, id desc', kind=None),
                    type_comment=None,
                ),
                Assign(
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Acquirer Account', kind=None),
                            ),
                            keyword(
                                arg='comodel_name',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='The anonymized acquirer reference of the payment method', kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    targets=[Name(id='acquirer_ref', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Char',
                        ...
                        keywords=[
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='The acquirer reference of the token of the transaction', kind=None),
                            ),
                            keyword(
                                arg='required',
                                value=Constant(value=True, kind=None),
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Payment Transactions', kind=None),
                            ),
                            keyword(
                                arg='comodel_name',
                            ...
                            keyword(
                                arg='inverse_name',
                                value=Constant(value='token_id', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
                ...
                Assign(
                    targets=[Name(id='verified', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Verified', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
