            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            ...
                            value=Call(
                                ...
                                keywords=[
                                    keyword(
                                        arg='login',
                                        value=Constant(value='user_system', kind=None),
                                    ),
                                    keyword(
                                        arg='groups',
                                        value=Constant(value='base.group_user,base.group_system', kind=None),
                                    ),
                                ],
                            ),
                            type_comment=None,
                        ...
                        Assign(
                            targets=[Name(id='sms_enabled_models', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        For(
                            ...
                            iter=Name(id='sms_enabled_models', ctx=Load()),
                            body=[
                                Expr(
                                    value=Call(
                                        func=Attribute(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[
                                                    BinOp(
                                                        left=Constant(value='SMS Template ', kind=None),
                                                        op=Add(),
                                                        right=Attribute(
                                                    ...
                                                    Constant(value='Body Test', kind=None),
                                                    Attribute(
                                                        value=Name(id='model', ctx=Load()),
                                                        attr='id',
                                                        ctx=Load(),
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='{{ object.name }}', kind=None),
                                            Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Call(
                ...
                FunctionDef(
                    ...
                    body=[
                        For(
                            target=Name(id='sms_template', ctx=Store()),
                            iter=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                        ...
                                        Expr(
                                            value=Call(
                                                ...
                                                args=[
                                                    Dict(
                                                        keys=[Constant(value='name', kind=None)],
                                                        values=[Constant(value='Update Template', kind=None)],
                                                    ),
                                                ],
                                                keywords=[],
                                            ),
                                            ...
                                            value=Call(
                                                ...
                                                args=[
                                                    Dict(
                                                        ...
                                                        values=[
                                                            BinOp(
                                                                left=Constant(value='New SMS Template ', kind=None),
                                                                op=Add(),
                                                                right=Attribute(
                                                                    value=Attribute(
                                                                        value=Name(id='sms_template', ctx=Load()),
                ...
                FunctionDef(
                                    ...
                                    value=Call(
                                        ...
                                        args=[
                                            Dict(
                                                ...
                                                values=[Constant(value='New body from admin', kind=None)],
                                            ),
                                        ],
                                        keywords=[],
                                    ),
                    ...
                    decorator_list=[
                        Call(
                            func=Name(id='users', ctx=Load()),
                            args=[Constant(value='user_system', kind=None)],
                            keywords=[],
                        ),
                        Call(
                            func=Name(id='mute_logger', ctx=Load()),
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='sms_composer', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='sms_composer', ctx=Load()),
                                        attr='body',
                                        ctx=Load(),
                                    ),
                                    Attribute(
                                    ...
                                    Constant(value='Simple user should be able to render SMS template', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='{{ object.name }}', kind=None),
                                    Constant(value='In mass mode, we should not render the template', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='In mass mode, if the user did not change the body, he should be able to render it', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                        Assign(
                            ...
                            value=Constant(value='New body: {{ 4 + 9 }}', kind=None),
                            type_comment=None,
                        ),
                        With(
                            items=[
                                withitem(
                                    context_expr=Call(
                                        ...
                                        keywords=[
                                            keyword(
                                                arg='msg',
                                                value=Constant(value='User should not be able to write new inline_template code', kind=None),
                                            ),
                                        ],
                                    ),
                                    optional_vars=None,
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Name(id='body', ctx=Load()),
                                    Constant(value='Template Editor should be able to write new Jinja code', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
