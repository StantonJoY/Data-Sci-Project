        ...
        ClassDef(
            ...
            body=[
                            ...
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        ...
                                        args=[
                                            Name(id='TestCRMLeadMultiCompany', ctx=Load()),
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Ensure global data for those tests to avoid unwanted side effects ', kind=None),
                        ),
                        Expr(
                            value=Call(
                                func=Attribute(
                ...
                FunctionDef(
                    ...
                    body=[
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='lead_no_team', ctx=Load()),
                                        attr='company_id',
                                        ctx=Load(),
                                    ),
                                ],
                        ...
                        Assign(
                            targets=[Name(id='lead_team_c2', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    Attribute(
                                        value=Name(id='lead_team_c2', ctx=Load()),
                                        attr='company_id',
                                        ctx=Load(),
                                    ),
                                    Attribute(
                        ...
                        Assign(
                            targets=[Name(id='lead_team_no_company', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Subscript(
                                        value=Attribute(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='No company', kind=None),
                                            Attribute(
                                                value=Attribute(
                                                    value=Name(id='self', ctx=Load()),
                                                    attr='sales_team_1',
                        ...
                        Assign(
                            targets=[
                                Attribute(
                                    value=Name(id='lead_team_no_company', ctx=Load()),
                                    attr='team_id',
                                    ctx=Store(),
                                ),
                            ],
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='user_sales_manager_mc', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Test lead company computation using form view ', kind=None),
                        ),
                        Assign(
                            targets=[Name(id='crm_lead_form', ctx=Store())],
                            value=Call(
                        ...
                        Assign(
                            targets=[
                                Attribute(
                                    value=Name(id='crm_lead_form', ctx=Load()),
                                    attr='name',
                                    ctx=Store(),
                                ),
                            ],
                            value=Constant(value='Test Lead', kind=None),
                            type_comment=None,
                        ),
                        Expr(
                            value=Call(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Test Progressive Setup', kind=None),
                                            Constant(value=False, kind=None),
                                            Constant(value=False, kind=None),
                                        ],
                                    ),
