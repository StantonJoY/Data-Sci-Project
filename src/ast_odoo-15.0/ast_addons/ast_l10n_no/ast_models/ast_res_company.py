                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                ...
                                end_col_offset=92,
                                arg='related',
                                value=Constant(lineno=8, col_offset=53, end_lineno=8, end_col_offset=92, value='partner_id.l10n_no_bronnoysund_number', kind=None),
                            ),
                            keyword(
                                lineno=8,
                                col_offset=94,
                                ...
                                end_col_offset=108,
                                arg='readonly',
                                value=Constant(lineno=8, col_offset=103, end_lineno=8, end_col_offset=108, value=False, kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
