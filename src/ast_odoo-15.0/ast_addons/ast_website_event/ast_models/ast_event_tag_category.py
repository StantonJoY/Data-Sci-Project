        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(lineno=8, col_offset=12, end_lineno=8, end_col_offset=32, value='event.tag.category', kind=None),
                    type_comment=None,
                ),
                Assign(
                    lineno=9,
                    ...
                    value=List(
                        ...
                        end_col_offset=64,
                        elts=[
                            Constant(lineno=9, col_offset=16, end_lineno=9, end_col_offset=36, value='event.tag.category', kind=None),
