            ...
            body=[
                FunctionDef(
                    ...
                    body=[
                        ...
                        Assign(
                            targets=[Name(id='group_sale_user', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Attribute(
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Le Grand Jojo User', kind=None),
                                            Constant(value='grand.jojo', kind=None),
                                            Constant(value='grand.jojo@chansonbelge.com', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                                                            ...
                                                            List(
                                                                elts=[
                                                                    Attribute(
                                                                        value=Name(id='group_sale_user', ctx=Load()),
                                                                        attr='id',
                                                                        ctx=Load(),
                                                                    ),
                                                                ],
                            ...
                            value=Call(
                                ...
                                args=[
                                    Dict(
                                        ...
                                        values=[
                                            Constant(value='Jean-Luc Fonck', kind=None),
                                            Constant(value='jl.fonck', kind=None),
                                            Constant(value='jl.fonck@chansonbelge.com', kind=None),
                                            List(
                                                elts=[
                                                    Tuple(
                                                        elts=[
                ...
                FunctionDef(
                    ...
                    body=[
                        Expr(
                            value=Constant(value=' Check a saleperson (only) can generate a PO and a PO user can not confirm a SO ', kind=None),
                        ),
                        Assign(
                        ...
                        Assign(
                            targets=[Name(id='sol_service_purchase', ctx=Store())],
                            value=Call(
                                func=Attribute(
                                    value=Call(
                                        func=Attribute(
                        ...
                        Expr(
                            value=Call(
                                ...
                                args=[
                                    ...
                                    Constant(value='Saleperson can read its own SO', kind=None),
                                ],
                                keywords=[],
                            ),
                        ),
                                    ...
                                    value=Call(
                                        func=Attribute(
                                            value=Attribute(
                                                value=Call(
                                                    func=Attribute(
                                                        value=Name(id='sol_service_purchase', ctx=Load()),
                                                        attr='with_user',
                                                        ctx=Load(),
                                                    ),
                                                    args=[
