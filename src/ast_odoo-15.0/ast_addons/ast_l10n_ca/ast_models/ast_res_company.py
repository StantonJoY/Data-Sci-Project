    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='l10n_ca_pst', ctx=Store())],
                    value=Call(
                        func=Attribute(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='partner_id.l10n_ca_pst', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='PST', kind=None),
                            ),
                            keyword(
                                arg='store',
                ...
                Assign(
                    ...
                    value=Call(
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='company_id.l10n_ca_pst', kind=None),
                            ),
                            keyword(
                                arg='readonly',
