    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='global_leave_id', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Many2one',
                        ...
                        keywords=[
                            keyword(
                                arg='string',
                                value=Constant(value='Global Time Off', kind=None),
                            ),
                            keyword(
                                arg='ondelete',
                                    ...
                                    exc=Call(
                                        ...
                                        args=[
                                            Call(
                                                ...
                                                args=[Constant(value='You cannot delete timesheets linked to time off. Please, cancel the time off instead.', kind=None)],
                                                keywords=[],
                                            ),
                                        ],
                                        keywords=[],
