        ...
        ClassDef(
            ...
            body=[
                Assign(
                    ...
                    value=Constant(value='fleet.vehicle.assignation.log', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_description', ctx=Store())],
                    value=Constant(value='Drivers history on a vehicle', kind=None),
                    type_comment=None,
                ),
                Assign(
                    targets=[Name(id='_order', ctx=Store())],
                    value=Constant(value='create_date desc, date_start desc', kind=None),
                    type_comment=None,
                ),
                Assign(
