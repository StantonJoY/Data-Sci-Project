    ...
    body=[
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='description_pad', ctx=Store())],
                    value=Call(
                        func=Attribute(
                ...
                Assign(
                    targets=[Name(id='use_pad', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        keywords=[
                            keyword(
                                arg='related',
                                value=Constant(value='project_id.use_pads', kind=None),
                            ),
                            keyword(
                                arg='string',
                                value=Constant(value='Use collaborative pad', kind=None),
                            ),
                            keyword(
                                arg='readonly',
                ...
                FunctionDef(
                        ...
                        If(
                            ...
                            body=[
                                Assign(
                                    ...
                                    value=Dict(
                                        keys=[Constant(value='description_pad', kind=None)],
                                        values=[
                                            Attribute(
                                                value=Name(id='self', ctx=Load()),
                                                attr='description_pad',
                    ...
                    decorator_list=[
                        Call(
                            ...
                            args=[Constant(value='use_pad', kind=None)],
                            keywords=[],
                        ),
                    ],
                    returns=None,
        ...
        ClassDef(
            ...
            body=[
                ...
                Assign(
                    targets=[Name(id='use_pads', ctx=Store())],
                    value=Call(
                        func=Attribute(
                            value=Name(id='fields', ctx=Load()),
                            attr='Boolean',
                        ...
                        args=[Constant(value='Use collaborative pads', kind=None)],
                        keywords=[
                            keyword(
                                arg='default',
                                value=Constant(value=True, kind=None),
                            ...
                            keyword(
                                arg='help',
                                value=Constant(value='Use collaborative pad for the tasks on this project.', kind=None),
                            ),
                        ],
                    ),
                    type_comment=None,
